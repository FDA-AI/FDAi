...
angular.module('starter').factory('qmService', ["$http", "$q", "$rootScope", "$ionicPopup", "$state", "$timeout",
    "$ionicPlatform", "$mdDialog", "$mdToast", "CacheFactory", "$ionicLoading",
    "$ionicHistory", "$ionicActionSheet", "clipboard",
    function($http, $q, $rootScope, $ionicPopup, $state, $timeout, $ionicPlatform, $mdDialog, $mdToast, CacheFactory, $ionicLoading,
             $ionicHistory,
