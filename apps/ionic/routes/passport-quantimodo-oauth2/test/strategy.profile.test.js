...
describe('Strategy#userProfile', function() {
  ...
  describe('fetched from default endpoint', function() {
    ...
    var quantimodoProfileRaw = '{"user":{"age":36,"avatar":"https://static0.quantimo.do/images/profile/defaultProfile_100_male.gif","avatar150":"https://static0.quantimo.do/images/profile/defaultProfile_150_male.gif","averageDailySteps":0,"corporate":false,"corporateAdmin":false,"country":"ES","dateOfBirth":"1980-02-01","displayName":"Homer","distanceUnit":"METRIC","encodedId":"AAA111","features":{"exerciseGoal":true},"foodsLocale":"es_ES","fullName":"Homer Simpson","gender":"MALE","glucoseUnit":"METRIC","height":172,"heightUnit":"METRIC","locale":"es_ES","memberSince":"2016-06-09","offsetFromUTCMillis":7200000,"startDayOfWeek":"MONDAY","strideLengthRunning":89.5,"strideLengthRunningType":"default","strideLengthWalking":71.4,"strideLengthWalkingType":"default","timezone":"Europe/Madrid","topBadges":[],"waterUnit":"METRIC","waterUnitName":"ml","weight":67,"weightUnit":"METRIC"}}';

    strategy._oauth2.get = function(url, accessToken, callback) {
      expect(url).to.equal('https://app.quantimo.do/1/user/-/profile.json');
      expect(accessToken).to.equal('token');
      callback(null, quantimodoProfileRaw, undefined);
    ...
    it('should parse profile', function() {
      expect(profile.provider).to.equal('quantimodo');
    ...
    it('should set json property', function() {
      expect(profile._json).to.be.eql(JSON.parse(quantimodoProfileRaw));
    });
  });
  ...
  describe('error caused by invalid token', function() {
    ...
    strategy._oauth2.get = function(url, accessToken, callback) {
      var body = '{"errors":[{"errorType":"invalid_token","message":"Access token invalid: token. Visit https://dev.quantimo.do/docs/oauth2 for more information on the QuantiModo Web API authorization process."}],"success":false}';
    ...
    it('should error', function() {
      //TODO: Library should check QuantiModo error, similar to: https://github.com/jaredhanson/passport-quantimodo/blob/master/lib/strategy.js#L86
