...
class MusicVariableCategory extends QMVariableCategory {
	...
	public const HELP_TEXT = 'What music did you listen to?';
	public const FONT_AWESOME = FontAwesome::MUSIC_SOLID;
	public const ID = 251;
    public const IMAGE_URL = 'https://static.quantimo.do/img/variable_categories/musical_notes-96.png';
	public const ION_ICON = 'ion-music-note';
	public const MANUAL_TRACKING = false;
	public const MAXIMUM_ALLOWED_VALUE = null;
	public const MEASUREMENT_SYNONYM_SINGULAR_LOWERCASE = 'music';
	public const MINIMUM_ALLOWED_SECONDS_BETWEEN_MEASUREMENTS = null;
	public const MINIMUM_ALLOWED_VALUE = null;
	public const MORE_INFO = "Music listened to.";
	public const NAME = 'Music';
	public const ONSET_DELAY = 0;
	public const OUTCOME = false;
	public const PNG_PATH = 'img/variable_categories/music.png';
    public const PNG_URL = 'https://static.quantimo.do/img/variable_categories/music.png';
	...
	public const SVG_PATH = 'img/variable_categories/music.svg';
    public const SVG_URL = 'https://static.quantimo.do/img/variable_categories/music.svg';
	public const SYNONYMS = ['Music'];
	public const VALENCE = null;
	public const VARIABLE_CATEGORY_NAME = 'Music';
	public const VARIABLE_CATEGORY_NAME_SINGULAR = 'Music';
