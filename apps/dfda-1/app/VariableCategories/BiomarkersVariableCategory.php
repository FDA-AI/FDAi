...
class BiomarkersVariableCategory extends QMVariableCategory {
	...
	public const HELP_TEXT = 'What biomarker do you want to record?';
	public const FONT_AWESOME = FontAwesome::HEARTBEAT_SOLID;
	public const ID = 43;
    public const IMAGE_URL = 'https://static.quantimo.do/img/variable_categories/heart_monitor-96.png';
	public const ION_ICON = 'ion-ios-pulse';
	public const MANUAL_TRACKING = false; // Leave null so it's set at the variable level
	public const MAXIMUM_ALLOWED_VALUE = null;
	public const MEASUREMENT_SYNONYM_SINGULAR_LOWERCASE = 'measurement';
	public const MINIMUM_ALLOWED_SECONDS_BETWEEN_MEASUREMENTS = null;
	public const MINIMUM_ALLOWED_VALUE = null;
	public const MORE_INFO = "Your biomarkers show how well your body is functioning. They include blood pressure, heart rate, respiratory rate (or pulse), and temperature.";
	public const NAME = 'Biomarkers';
	public const ONSET_DELAY = 0;
	public const OUTCOME = true;
	public const PNG_PATH = 'img/variable_categories/vital-signs.png';
    public const PNG_URL = 'https://static.quantimo.do/img/variable_categories/vital-signs.png';
	...
	public const SVG_PATH = 'img/variable_categories/vital-signs.svg';
    public const SVG_URL = 'https://static.quantimo.do/img/variable_categories/vital-signs.svg';
	public const SYNONYMS = ['Biomarkers', 'Biomarker'];
	public const VALENCE = null;
	public const VARIABLE_CATEGORY_NAME = 'Biomarkers';
	public const VARIABLE_CATEGORY_NAME_SINGULAR = 'Biomarker';
