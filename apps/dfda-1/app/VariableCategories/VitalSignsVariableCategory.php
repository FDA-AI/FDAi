...
class VitalSignsVariableCategory extends QMVariableCategory {
	...
	public const HELP_TEXT = 'What vital sign do you want to record?';
	...
	public const MORE_INFO = "Your vital signs show how well your body is functioning. They include blood pressure, heart rate, respiratory rate (or pulse), and temperature.";
	public const NAME = 'Vital Signs';
	...
	public const SYNONYMS = ['Vital Signs', 'Vital Sign'];
	public const VALENCE = null;
	public const VARIABLE_CATEGORY_NAME = 'Vital Signs';
	public const VARIABLE_CATEGORY_NAME_SINGULAR = 'Vital Sign';
