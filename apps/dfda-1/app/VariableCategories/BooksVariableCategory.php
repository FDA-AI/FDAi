...
class BooksVariableCategory extends QMVariableCategory {
	public const AMAZON_PRODUCT_CATEGORY = 'Books';
	...
	public const ID = 19;
    public const IMAGE_URL = 'https://static.quantimo.do/img/variable_categories/books-96.png';
	public const ION_ICON = 'ion-ios-book';
	...
	public const MORE_INFO = "Record your books read so we can see which ones actually work. ";
	public const NAME = 'Books';
	public const ONSET_DELAY = 0;
	public const OUTCOME = false;
	public const PNG_PATH = 'img/variable_categories/books.png';
    public const PNG_URL = 'https://static.quantimo.do/img/variable_categories/books.png';
	...
	public const SVG_PATH = 'img/variable_categories/books.svg';
    public const SVG_URL = 'https://static.quantimo.do/img/variable_categories/books.svg';
	public const SYNONYMS = ['Books', 'Book'];
	public const VALENCE = null;
	public const VARIABLE_CATEGORY_NAME_SINGULAR = 'Book';
