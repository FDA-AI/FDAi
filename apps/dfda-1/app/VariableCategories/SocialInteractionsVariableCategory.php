...
class SocialInteractionsVariableCategory extends QMVariableCategory {
	...
	public const FONT_AWESOME = FontAwesome::COMMENT_ALT;
	public const ID = 7;
    public const IMAGE_URL = 'https://static.quantimo.do/img/variable_categories/collaboration-96.png';
	public const ION_ICON = 'ion-ios-chatboxes-outline';
	...
	public const MORE_INFO = "A social relation or social interaction is any relationship between two or more individuals. ";
	public const NAME = 'Social Interactions';
	public const ONSET_DELAY = 0;
	public const OUTCOME = true;
	public const PNG_PATH = 'img/variable_categories/social-interactions.png';
    public const PNG_URL = 'https://static.quantimo.do/img/variable_categories/social-interactions.png';
	public const PREDICTOR = true;
	public const PUBLIC = false;
	public const SETUP_QUESTION = null;
	public const STUDY_IMAGE_FILE_NAME = 'social-interaction';
	public const SUFFIX = null;
	public const SVG_PATH = 'img/variable_categories/social-interactions.svg';
    public const SVG_URL = 'https://static.quantimo.do/img/variable_categories/social-interactions.svg';
	public const SYNONYMS = ['Social Interactions', 'Social Interaction'];
	public const VALENCE = null;
	public const VARIABLE_CATEGORY_NAME_SINGULAR = 'Social Interaction';
