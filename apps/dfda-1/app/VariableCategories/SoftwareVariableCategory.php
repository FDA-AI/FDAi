...
class SoftwareVariableCategory extends QMVariableCategory {
	...
	public const FONT_AWESOME = FontAwesome::LAPTOP_CODE_SOLID;
	public const ID = 20;
	...
	public const MORE_INFO = "Record time spend using specific software or websites. ";
	public const NAME = 'Software';
	...
	public const SYNONYMS = ['Software & Mobile Apps', 'App', 'Software', 'Software & Mobile App', "Software Usage"];
	public const VALENCE = null;
	public const VARIABLE_CATEGORY_NAME_SINGULAR = 'Software';
