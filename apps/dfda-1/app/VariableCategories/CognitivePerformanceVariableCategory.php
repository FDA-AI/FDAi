...
class CognitivePerformanceVariableCategory extends QMVariableCategory {
	...
	public const FONT_AWESOME = FontAwesome::BRAIN_SOLID;
	public const ID = 9;
    public const IMAGE_URL = 'https://static.quantimo.do/img/variable_categories/brain-96.png';
	public const ION_ICON = 'ion-arrow-graph-up-right';
	...
	public const MORE_INFO = "See what factors could be harming or enhancing your cognitive performance.";
	public const NAME = 'Cognitive Performance';
	public const ONSET_DELAY = 0;
	public const OUTCOME = true;
	public const PNG_PATH = 'img/variable_categories/cognitive-performance.png';
    public const PNG_URL = 'https://static.quantimo.do/img/variable_categories/cognitive-performance.png';
	...
	public const SVG_PATH = 'img/variable_categories/cognitive-performance.svg';
    public const SVG_URL = 'https://static.quantimo.do/img/variable_categories/cognitive-performance.svg';
	public const SYNONYMS = ['Cognitive Performance'];
	public const VALENCE = BaseValenceProperty::VALENCE_POSITIVE;
	public const VARIABLE_CATEGORY_NAME_SINGULAR = 'Cognitive Performance';
