...
class EconomicIndicatorsVariableCategory extends QMVariableCategory
{
    ...
    public const DEFAULT_UNIT_ABBREVIATED_NAME = IndexUnit::ABBREVIATED_NAME;
    ...
    public const FONT_AWESOME = FontAwesome::CHARTS;
    public const ID = 254;
    public const IMAGE_URL = ImageUrls::CHARTS;
    ...
    public const MORE_INFO = "An economic indicator is a piece of economic data, usually of macroeconomic scale, that is used by analysts to interpret current or future investment possibilities.";
    public const NAME = 'Economic Indicators';
    public const ONSET_DELAY = 0;
    public const OUTCOME = true;
    public const PNG_PATH = ImageUrls::CHARTS;
    public const PNG_URL = ImageUrls::CHARTS;
    ...
    public const SYNONYMS = ['Economic Data', self::NAME];
    public const VALENCE = null;
    public const VARIABLE_CATEGORY_NAME_SINGULAR = 'Economic Indicator';
