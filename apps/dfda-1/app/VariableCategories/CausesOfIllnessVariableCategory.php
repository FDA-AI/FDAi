...
class CausesOfIllnessVariableCategory extends QMVariableCategory {
	...
	public const FONT_AWESOME = FontAwesome::DISEASE_SOLID;
	public const ID = 18;
    public const IMAGE_URL = 'https://static.quantimo.do/img/variable_categories/virus-96.png';
	...
	public const MORE_INFO = "Factors leading or increasing the severity of illness or disease. ";
	public const NAME = 'Causes of Illness';
	public const ONSET_DELAY = 0;
	public const OUTCOME = false;
	public const PNG_PATH = 'img/variable_categories/causes-of-illness.png';
    public const PNG_URL = 'https://static.quantimo.do/img/variable_categories/causes-of-illness.png';
	...
	public const SVG_PATH = 'img/variable_categories/causes-of-illness.svg';
    public const SVG_URL = 'https://static.quantimo.do/img/variable_categories/causes-of-illness.svg';
	public const SYNONYMS = [
        'Causes of Illness',
        'Cause of Illness',
    ];
	public const VALENCE = null;
	public const VARIABLE_CATEGORY_NAME_SINGULAR = 'Cause of Illness';
