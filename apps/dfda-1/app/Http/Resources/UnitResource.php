...
//'aggregate_correlations_where_cause_unit' => AggregateCorrelationResource::collection($this->whenLoaded('aggregate_correlations_where_cause_unit')),
//'aggregate_correlations_where_cause_unit' => AggregateCorrelationResource::collection($this->whenLoaded('aggregate_correlations_where_cause_unit')),
//'aggregate_correlations_where_cause_unit_count' => $this->aggregate_correlations_where_cause_unit_count,
//'aggregateCorrelations' => AggregateCorrelationResource::collection($this->whenLoaded('aggregateCorrelations')),
//'aggregateCorrelations' => AggregateCorrelationResource::collection($this->whenLoaded('aggregateCorrelations')),
