...
//'aggregate_correlations_where_cause_variable_category' => AggregateCorrelationResource::collection($this->whenLoaded('aggregate_correlations_where_cause_variable_category')),
//'aggregate_correlations_where_cause_variable_category_count' => $this->aggregate_correlations_where_cause_variable_category_count,
//'aggregate_correlations_where_effect_variable_category' => AggregateCorrelationResource::collection($this->whenLoaded('aggregate_correlations_where_effect_variable_category')),
//'aggregate_correlations_where_effect_variable_category_count' => $this->aggregate_correlations_where_effect_variable_category_count,
