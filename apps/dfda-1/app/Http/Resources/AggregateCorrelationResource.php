...
/** @mixin \App\Models\AggregateCorrelation */
class AggregateCorrelationResource extends BaseJsonResource
{
    ...
    public function toArray($request): array
    {
        ...
        $arr = array_merge($arr, [
            ...
            'number_of_variables_where_best_aggregate_correlation' => $this->number_of_variables_where_best_aggregate_correlation,
            ...
            'variables_where_best_aggregate_correlation' => VariableResource::collection($this->whenLoaded('variables_where_best_aggregate_correlation')),
            //'variables_where_best_aggregate_correlation' => VariableResource::collection($this->whenLoaded
            //('variables_where_best_aggregate_correlation')),
            'variables_where_best_aggregate_correlation_count' => $this->variables_where_best_aggregate_correlation_count,
            'vote' => $this->vote,
