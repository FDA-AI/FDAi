...
class DollarsUnit extends QMUnit {
	public const ABBREVIATED_NAME = '$';
	public const ADVANCED = 1;
	public const CATEGORY_ID = 12;
	public const CATEGORY_NAME = 'Currency';
	...
	public const NAME = 'Dollars';
	public const SCALE = 'ratio';
	public const SUFFIX = null;
	public const SYNONYMS = ['Dollars', '$', 'Dollar'];
