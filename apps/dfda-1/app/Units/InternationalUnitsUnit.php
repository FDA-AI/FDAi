...
class InternationalUnitsUnit extends QMUnit {
	public const ABBREVIATED_NAME = 'IU';
	...
	public const NAME = 'International Units';
	public const SCALE = 'ratio';
	public const SUFFIX = null;
	public const SYNONYMS = ['International Units', 'IU', 'International Unit'];
