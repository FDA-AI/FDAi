...
class CapsulesUnit extends QMUnit {
	...
	public const ABBREVIATED_NAME = 'capsules';
	...
	public const MAXIMUM_VALUE = 1000;
	public const MINIMUM_VALUE = 0;
	public const NAME = 'Capsules';
	public const SCALE = 'ratio';
	public const SUFFIX = null;
	public const SYNONYMS = ['Capsules', 'capsules', 'Capsule', 'capsule'];
