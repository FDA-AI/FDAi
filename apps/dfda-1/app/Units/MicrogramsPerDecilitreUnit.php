...
class MicrogramsPerDecilitreUnit extends QMUnit {
	public const ABBREVIATED_NAME = 'mg/dL';
	...
	public const NAME = 'Micrograms per decilitre';
	public const SCALE = 'ratio';
	public const SUFFIX = null;
	public const SYNONYMS = ['Micrograms per decilitre', 'mg/dL'];
