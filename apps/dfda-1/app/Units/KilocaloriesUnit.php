...
class KilocaloriesUnit extends QMUnit {
	public const ABBREVIATED_NAME = 'kcal';
	...
	public const NAME = 'Kilocalories';
	public const SCALE = 'ratio';
	public const SUFFIX = null;
	public const SYNONYMS = ['Kilocalories', 'kcal', 'Kilocalory'];
