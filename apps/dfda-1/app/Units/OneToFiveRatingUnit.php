...
class OneToFiveRatingUnit extends QMUnit {
	public const ABBREVIATED_NAME = '/5';
	...
	public const NAME = '1 to 5 Rating';
	public const SCALE = 'ordinal';
	public const SUFFIX = null;
	public const SYNONYMS = ['out of five', 'out of 5', '1 to 5 Rating', '/5'];
