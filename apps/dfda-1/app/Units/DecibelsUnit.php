...
class DecibelsUnit extends QMUnit {
	public const ABBREVIATED_NAME = 'dB';
	...
	public const NAME = 'Decibels';
	public const SCALE = 'ratio';
	public const SUFFIX = null;
	public const SYNONYMS = ['Decibels', 'dB', 'Decibel'];
	...
	public $image = ImageUrls::MEDICAL_EAR;
	public $fontAwesome = FontAwesome::SPEAKER_DECK;
}
