...
class DegreesEastUnit extends QMUnit {
	public const ABBREVIATED_NAME = 'degrees east';
	...
	public const NAME = 'Degrees East';
	public const SCALE = 'interval';
	public const SUFFIX = null;
	public const SYNONYMS = ['Degrees East', 'degrees east'];
