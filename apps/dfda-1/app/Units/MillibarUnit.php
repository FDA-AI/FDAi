...
class MillibarUnit extends QMUnit {
	public const ABBREVIATED_NAME = 'mbar';
	...
	public const MAXIMUM_VALUE = 10130;
	public const MINIMUM_VALUE = 101;
	public const NAME = 'Millibar';
	public const SCALE = 'ratio';
	public const SUFFIX = null;
	public const SYNONYMS = ['Millibar', 'mbar'];
