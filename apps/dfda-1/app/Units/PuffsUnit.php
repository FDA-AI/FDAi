...
class PuffsUnit extends QMUnit {
	public const ABBREVIATED_NAME = 'puffs';
	...
	public const MAXIMUM_VALUE = 100;
	public const MINIMUM_VALUE = 0;
	public const NAME = 'Puffs';
	public const SCALE = 'ratio';
	public const SUFFIX = null;
	public const SYNONYMS = ['Puffs', 'puffs', 'Puff', 'puff'];
