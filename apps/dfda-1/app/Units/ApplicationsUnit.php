...
class ApplicationsUnit extends QMUnit {
	...
	public const ABBREVIATED_NAME = 'applications';
	...
	public const SYNONYMS = ['Applications', 'applications', 'Application', 'application'];
