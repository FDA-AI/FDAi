...
class MillisecondsUnit extends QMUnit {
	public const ABBREVIATED_NAME = 'ms';
	...
	public const MAXIMUM_VALUE = 864000000;
	...
	public const SYNONYMS = ['Milliseconds', 'ms', 'Millisecond'];
