...
class ActionEvent extends Model
{
     ...
     * @return \Illuminate\Database\Eloquent\Model
     */
    public static function forAttachedResource(AstralRequest $request, $parent, $pivot)
    {
        return new static([
            'batch_id' => (string) Str::orderedUuid(),
            ...
            'target_type' => Astral::modelInstanceForKey($request->relatedResource)->getMorphClass(),
     ...
     * @return \Illuminate\Database\Eloquent\Model
     */
    public static function forAttachedResourceUpdate(AstralRequest $request, $parent, $pivot)
    {
        return new static([
            'batch_id' => (string) Str::orderedUuid(),
            'user_id' => $request->user()->getAuthIdentifier(),
