...
use App\Exceptions\MissingActionHandlerException;
...
class Action implements JsonSerializable
{
    ...
    {
        return $this->batchId ? Astral::actionEvent()->markAsFinished($this->batchId, $model) : 0;
    }
    ...
    {
        return $this->batchId ? Astral::actionEvent()->markAsFailed($this->batchId, $model, $e) : 0;
    }
