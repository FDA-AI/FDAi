...
use App\Filament\Resources\AggregateCorrelationResource\Pages;
use App\Filament\Resources\AggregateCorrelationResource\RelationManagers;
...
class AggregateCorrelationResource extends Resource
{
    protected static ?string $model = AggregateCorrelation::class;
	protected static ?string $modelLabel = AggregateCorrelation::CLASS_DISPLAY_NAME;
        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('charts')
                    ->required(),
                Forms\Components\TextInput::make('number_of_variables_where_best_aggregate_correlation')
                    ->required(),
...
//                Tables\Columns\TextColumn::make('number_of_variables_where_best_aggregate_correlation'),
...
//                Tables\Columns\TextColumn::make('slug'),
    ...
    {
        return [
            'index' => Pages\ListAggregateCorrelations::route('/'),
            'create' => Pages\CreateAggregateCorrelation::route('/create'),
            'edit' => Pages\EditAggregateCorrelation::route('/{record}/edit'),
        ];
    }    
}
