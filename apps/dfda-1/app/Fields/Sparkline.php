...
class Sparkline extends Field
{
     ...
     *
     * @var array|\Closure|\App\Metrics\Trend
     */
    public $data = [];
     ...
     *
     * @param  array|\Closure|\App\Metrics\Trend  $data
     * @return $this
     */
     ...
     * @return array|mixed
     */
    public function getData(AstralRequest $request)
    {
    ...
    public function jsonSerialize(): mixed
    {
        return array_merge(parent::jsonSerialize(), [
            ...
            'data' => $this->getData(app(AstralRequest::class)),
        ]);
    }
}
