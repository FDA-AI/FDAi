...
abstract class FieldElement extends Element
{
     ...
     * @return bool
     */
    public function isShownOnUpdate(AstralRequest $request, $resource): bool
    {
     ...
     * @return bool
     */
    public function isShownOnIndex(AstralRequest $request, $resource): bool
    {
     ...
     * @return bool
     */
    public function isShownOnDetail(AstralRequest $request, $resource): bool
    {
     ...
     * @return bool
     */
    public function isShownOnCreation(AstralRequest $request): bool
    {
