...
class GlobalVariableRelationshipsNetworkGraphQMChart extends NetworkGraphQMChart {
	...
	/**
	 * @return VariableTrait|QMVariable
	 */
	...
	public function getSubtitleAttribute(): string{
		...
		$limit = $this->limit;
		$correlations = $variable->getPublicOutcomesOrPredictors($limit);
