...
namespace App\Charts\QMHighcharts\Highcharts\ScatterAndBubble\ScatterPlot;
...
class BaseScatterPlot extends HighchartConfig {
	/**
	 * @var BaseChart
	...
	public function __construct(){
		...
		$this->title->text = "Height Versus Weight of 507 Individuals by Gender";
		$this->subtitle->text = "Source: Heinz 2003";
		$this->xAxis->title->enabled = 1;
		$this->xAxis->title->text = "Height (cm)";
		$this->xAxis->startOnTick = 1;
		$this->xAxis->endOnTick = 1;
		$this->xAxis->showLastLabel = 1;
		$this->yAxis->title->text = "Weight (kg)";
		...
		$this->plotOptions->scatter->marker->radius = 5;
		$this->plotOptions->scatter->marker->states->hover->enabled = 1;
		$this->plotOptions->scatter->marker->states->hover->lineColor = "rgb(100,100,100)";
		$this->plotOptions->scatter->states->hover->marker->enabled = false;
		$this->series[] = [
			'name' => "Female",
	...
	public function demo(): string{
		...
		require base_path('vendor/ghunti/highcharts-php/demos/highcharts/scatter_and_bubble/scatter_plot.php');
	}
}
