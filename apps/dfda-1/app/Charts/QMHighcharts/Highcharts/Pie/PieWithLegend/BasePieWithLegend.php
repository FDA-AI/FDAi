...
namespace App\Charts\QMHighcharts\Highcharts\Pie\PieWithLegend;
...
class BasePieWithLegend extends HighchartConfig {
	/**
	 * @var BaseChart
	...
	public function __construct(){
		...
		$this->plotOptions->pie->dataLabels->enabled = false;
		$this->plotOptions->pie->showInLegend = 1;
		$this->series[] = [
			'type' => "pie",
			'name' => "Browser share",
			'data' => [
	...
	public function demo(): string{
		...
		require base_path('vendor/ghunti/highcharts-php/demos/highcharts/pie/pie_with_legend.php');
	}
}
