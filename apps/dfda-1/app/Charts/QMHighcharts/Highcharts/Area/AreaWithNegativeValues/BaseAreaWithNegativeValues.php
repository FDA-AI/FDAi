...
namespace App\Charts\QMHighcharts\Highcharts\Area\AreaWithNegativeValues;
...
class BaseAreaWithNegativeValues extends HighchartConfig {
	/**
	 * @var BaseChart
	...
	public function __construct(){
		...
		$this->title->text = "Area chart with negative values";
	...
	public function demo(): string{
		...
		require base_path('vendor/ghunti/highcharts-php/demos/highcharts/area/area_with_negative_values.php');
	}
}
