...
namespace App\Charts\QMHighcharts\Highcharts\Area\StackedChart;
...
class BaseStackedChart extends HighchartConfig {
	/**
	 * @var BaseChart
	...
	public function __construct(){
		...
		$this->title->text = "Historic and Estimated Worldwide Population Growth by Region";
		...
		$this->yAxis->title->text = "Billions";
		$this->yAxis->labels->formatter = new HighchartJsExpr("function() { return this.value / 1000; }");
		$this->tooltip->formatter =
			new HighchartJsExpr("function() { return '' + this.x +': '+ Highcharts.numberFormat(this.y, 0, ',') +' millions';}");
		$this->plotOptions->area->stacking = "normal";
		$this->plotOptions->area->lineColor = "#666666";
		$this->plotOptions->area->lineWidth = 1;
		$this->plotOptions->area->marker->lineWidth = 1;
		$this->plotOptions->area->marker->lineColor = "#666666";
		$this->series[] = [
			'name' => "Asia",
			'data' => [
				502,
	...
	public function demo(): string{
		...
		require base_path('vendor/ghunti/highcharts-php/demos/highcharts/area/stacked_chart.php');
	}
}
