...
namespace App\Charts\QMHighcharts\Highcharts\ColumnAndBar\StackedBar;
...
class BaseStackedBar extends HighchartConfig {
	/**
	 * @var BaseChart
	...
	public function demo(): string{
		...
		require base_path('vendor/ghunti/highcharts-php/demos/highcharts/column_and_bar/stacked_bar.php');
	}
}
