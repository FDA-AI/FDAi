...
namespace App\Charts\QMHighcharts\Highcharts\Line\TimeSeriesZoomable;
...
class BaseTimeSeriesZoomable extends HighchartConfig {
	/**
	 * @var BaseChart
	...
	public function __construct(){
		...
		$this->title->text = 'USD to EUR exchange rate from 2006 through 2008';
		$this->subtitle->text = new HighchartJsExpr("document.ontouchstart === undefined ?
		                'Click and drag in the plot area to zoom in' :
		                'Drag your finger over the plot to zoom in'");
		$this->xAxis->type = 'datetime';
		$this->xAxis->maxZoom = 14 * 24 * 3600000;
		...
		$this->plotOptions->area->fillColor->linearGradient = [
			0,
			0,
			0,
			300,
		];
		$this->plotOptions->area->fillColor->stops = [
			[
				0,
		...
		$this->plotOptions->area->marker->states->hover->radius = 5;
		$this->plotOptions->area->shadow = false;
		$this->plotOptions->area->states->hover->lineWidth = 1;
		$this->series[] = [
			'type' => 'area',
			'name' => 'USD to EUR',
	...
	public function demo(): string{
		...
		require base_path('vendor/ghunti/highcharts-php/demos/highcharts/line/time_series_zoomable.php');
	}
}
