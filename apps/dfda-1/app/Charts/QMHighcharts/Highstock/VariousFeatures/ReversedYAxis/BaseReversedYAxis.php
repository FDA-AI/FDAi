...
namespace App\Charts\QMHighcharts\Highstock\VariousFeatures\ReversedYAxis;
...
class BaseReversedYAxis extends HighchartConfig {
	/**
	 * @var BaseChart
	...
	public function __construct(){
		...
		$this->yAxis->reversed = 1;
		$this->yAxis->showFirstLabel = false;
		$this->yAxis->showLastLabel = 1;
		...
		$this->series[0]->fillColor->linearGradient->y1 = 1;
		$this->series[0]->fillColor->linearGradient->x2 = 0;
		$this->series[0]->fillColor->linearGradient->y2 = 0;
	...
	public function demo(): string{
		...
		require base_path('vendor/ghunti/highcharts-php/demos/highstock/various_features/reversed_y_axis.php');
	}
}
