...
namespace App\Charts\QMHighcharts\Highstock\ChartTypes\StepLine;
...
class BaseStepLine extends HighchartConfig {
	/**
	 * @var BaseChart
	...
	public function demo(): string{
		...
		require base_path('vendor/ghunti/highcharts-php/demos/highstock/chart_types/step_line.php');
	}
}
