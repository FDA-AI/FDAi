...
namespace App\Charts\QMHighcharts\Highstock\ChartTypes\PointMarkersOnly;
...
class BasePointMarkersOnly extends HighchartConfig {
	/**
	 * @var BaseChart
	...
	public function demo(): string{
		...
		require base_path('vendor/ghunti/highcharts-php/demos/highstock/chart_types/point_markers_only.php');
	}
}
