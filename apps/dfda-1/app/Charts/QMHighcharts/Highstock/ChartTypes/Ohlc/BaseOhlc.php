...
namespace App\Charts\QMHighcharts\Highstock\ChartTypes\Ohlc;
...
class BaseOhlc extends HighchartConfig {
	/**
	 * @var BaseChart
	...
	public function demo(): string{
		...
		require base_path('vendor/ghunti/highcharts-php/demos/highstock/chart_types/ohlc.php');
	}
}
