...
namespace App\Charts\QMHighcharts\Highstock\ChartTypes\LineWithMarkersAndShadow;
...
class BaseLineWithMarkersAndShadow extends HighchartConfig {
	/**
	 * @var BaseChart
	...
	public function demo(): string{
		...
		require base_path('vendor/ghunti/highcharts-php/demos/highstock/chart_types/line_with_markers_and_shadow.php');
	}
}
