...
namespace App\Charts\QMHighcharts\Highstock\ChartTypes\Areaspline;
...
class BaseAreaspline extends HighchartConfig {
	...
	public function demo(): string{
		...
		require base_path('vendor/ghunti/highcharts-php/demos/highstock/chart_types/areaspline.php');
	}
}
