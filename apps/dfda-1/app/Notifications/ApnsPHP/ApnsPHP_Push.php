<?php
namespace App\Notifications\ApnsPHP;
...
class ApnsPHP_Push extends ApnsPHP_Abstract
{
	...
	protected $_aErrorResponseMessages = [
	...
	protected $_aHTTPErrorResponseMessages = [
		200 => 'Success',
		400 => 'Bad request',
	...
	private function _httpSend(ApnsPHP_Message $message, &$sReply)
	{
		...
		if (!(curl_setopt_array($this->_hSocket, [
				CURLOPT_POST => true,
