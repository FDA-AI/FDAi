...
class WpPostUserButton extends BelongsToRelationshipButton {
	public $interesting = true;
	public $foreignKeyName = WpPost::FIELD_POST_AUTHOR;
	public $qualifiedForeignKeyName = WpPost::TABLE . '.' . WpPost::FIELD_POST_AUTHOR;
	public $ownerKeyName = User::FIELD_ID;
	public $qualifiedOwnerKeyName = User::TABLE . '.' . User::FIELD_ID;
	public $childClass = WpPost::class;
