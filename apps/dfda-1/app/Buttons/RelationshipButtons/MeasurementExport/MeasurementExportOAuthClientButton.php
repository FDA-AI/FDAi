...
class MeasurementExportOAuthClientButton extends BelongsToRelationshipButton {
	public $interesting = false;
	public $foreignKeyName = OAClient::FIELD_ID;
	public $qualifiedForeignKeyName = MeasurementExport::TABLE . '.' . MeasurementExport::FIELD_CLIENT_ID;
