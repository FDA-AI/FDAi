...
use App\Models\Vote;
class VoteEffectVariableButton extends BelongsToRelationshipButton {
	public $interesting = true;
	public $foreignKeyName = Vote::FIELD_EFFECT_VARIABLE_ID;
	public $qualifiedForeignKeyName = Vote::TABLE . '.' . Vote::FIELD_EFFECT_VARIABLE_ID;
