...
namespace App\Buttons\RelationshipButtons\SourcePlatform;
use App\Buttons\RelationshipButtons\BelongsToRelationshipButton;
use App\Models\OAClient;
use App\Models\SourcePlatform;
class SourcePlatformOAuthClientButton extends BelongsToRelationshipButton {
	public $interesting = false;
	public $foreignKeyName = OAClient::FIELD_ID;
	public $qualifiedForeignKeyName = SourcePlatform::TABLE . '.' . SourcePlatform::FIELD_CLIENT_ID;
	public $ownerKeyName = OAClient::FIELD_ID;
	public $qualifiedOwnerKeyName = OAClient::TABLE . '.' . OAClient::FIELD_ID;
	public $childClass = SourcePlatform::class;
	public $parentClass = SourcePlatform::class;
	public $qualifiedParentKeyName = SourcePlatform::TABLE . '.' . SourcePlatform::FIELD_ID;
