...
class StudyEffectVariableButton extends BelongsToRelationshipButton {
	public $interesting = true;
	public $foreignKeyName = Study::FIELD_EFFECT_VARIABLE_ID;
	public $qualifiedForeignKeyName = Study::TABLE . '.' . Study::FIELD_EFFECT_VARIABLE_ID;
