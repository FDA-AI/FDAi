...
class GlobalVariableRelationshipEffectVariableCategoryButton extends BelongsToRelationshipButton {
	public $foreignKeyName = GlobalVariableRelationship::FIELD_EFFECT_VARIABLE_CATEGORY_ID;
	public $qualifiedForeignKeyName = GlobalVariableRelationship::TABLE.'.'.GlobalVariableRelationship::FIELD_EFFECT_VARIABLE_CATEGORY_ID;
