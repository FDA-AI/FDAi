...
class UserVariableClientOAuthClientButton extends BelongsToRelationshipButton {
    public $interesting = false;
	public $foreignKeyName = OAClient::FIELD_ID;
	public $qualifiedForeignKeyName = UserVariableClient::TABLE.'.'.UserVariableClient::FIELD_CLIENT_ID;
