...
class OAAuthorizationCodeOAuthClientButton extends BelongsToRelationshipButton {
    public $interesting = false;
	public $foreignKeyName = OAClient::FIELD_ID;
	public $qualifiedForeignKeyName = OAAuthorizationCode::TABLE.'.'.OAAuthorizationCode::FIELD_CLIENT_ID;
