...
class SearchVariablesWithCommonPredictorsStateButton extends IonicButton {
	public $accessibilityText = 'Select a Variable';
	public $action = '/#/app/search-variables-with-common-predictors';
	public $fontAwesome = 'far fa-list-alt';
	public $icon = 'ion-search';
	public $id = 'search-variables-with-common-predictors-state-button';
	public $image = 'https://static.quantimo.do/img/screenshots/variable-list-screenshot-caption.png';
	public $ionIcon = 'ion-search';
	public $link = '/#/app/search-variables-with-common-predictors';
	public $stateName = 'app.searchVariablesWithCommonPredictors';
	public $stateParams = [];
