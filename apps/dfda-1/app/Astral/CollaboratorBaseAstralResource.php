...
class CollaboratorBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = Collaborator::class;
    /**
    ...
    public static $group = Collaborator::CLASS_CATEGORY;
