...
class MeasurementExportBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = MeasurementExport::class;
    /**
    ...
    public static $group = MeasurementExport::CLASS_CATEGORY;
