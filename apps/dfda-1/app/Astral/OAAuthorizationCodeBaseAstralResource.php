...
class OAAuthorizationCodeBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = OAAuthorizationCode::class;
    /**
    ...
    public static $group = OAAuthorizationCode::CLASS_CATEGORY;
