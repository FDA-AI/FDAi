...
class SpreadsheetImporterBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = SpreadsheetImporter::class;
    /**
    ...
    public static $group = SpreadsheetImporter::CLASS_CATEGORY;
