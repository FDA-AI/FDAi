...
class PatientPhysicianBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = PatientPhysician::class;
    /**
    ...
    public static $group = PatientPhysician::CLASS_CATEGORY;
