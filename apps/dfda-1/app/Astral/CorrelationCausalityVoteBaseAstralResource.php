...
class CorrelationCausalityVoteBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = CorrelationCausalityVote::class;
    /**
    ...
    public static $group = CorrelationCausalityVote::CLASS_CATEGORY;
