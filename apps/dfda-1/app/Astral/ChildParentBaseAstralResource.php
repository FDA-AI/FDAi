...
class ChildParentBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = ChildParent::class;
    /**
    ...
    public static $group = ChildParent::CLASS_CATEGORY;
