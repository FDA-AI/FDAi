...
class CorrelationUsefulnessVoteBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = CorrelationUsefulnessVote::class;
    /**
    ...
    public static $group = CorrelationUsefulnessVote::CLASS_CATEGORY;
