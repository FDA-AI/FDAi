...
class CtTreatmentSideEffectBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = CtTreatmentSideEffect::class;
    /**
    ...
    public static $group = CtTreatmentSideEffect::CLASS_CATEGORY;
