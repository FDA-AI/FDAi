...
use App\Models\ConnectorDevice;
class ConnectorDeviceBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = ConnectorDevice::class;
    /**
    ...
    public static $group = ConnectorDevice::CLASS_CATEGORY;
