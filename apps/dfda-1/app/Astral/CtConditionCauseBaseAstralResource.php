...
class CtConditionCauseBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = CtConditionCause::class;
    /**
    ...
    public static $group = CtConditionCause::CLASS_CATEGORY;
