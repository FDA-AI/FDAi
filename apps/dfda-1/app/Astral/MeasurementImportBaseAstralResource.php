...
class MeasurementImportBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = MeasurementImport::class;
    /**
    ...
    public static $group = MeasurementImport::CLASS_CATEGORY;
