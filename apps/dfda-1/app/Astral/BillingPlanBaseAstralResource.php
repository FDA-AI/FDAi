...
class BillingPlanBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = BillingPlan::class;
    /**
    ...
    public static $group = BillingPlan::CLASS_CATEGORY;
