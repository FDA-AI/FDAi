...
class HealthCheckBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = HealthCheck::class;
    /**
    ...
    public static $group = HealthCheck::CLASS_CATEGORY;
