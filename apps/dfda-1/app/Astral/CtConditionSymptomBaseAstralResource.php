...
class CtConditionSymptomBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = CtConditionSymptom::class;
    /**
    ...
    public static $group = CtConditionSymptom::CLASS_CATEGORY;
