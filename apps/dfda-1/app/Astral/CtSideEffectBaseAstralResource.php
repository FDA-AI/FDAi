...
class CtSideEffectBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = CtSideEffect::class;
    /**
    ...
    public static $group = CtSideEffect::CLASS_CATEGORY;
