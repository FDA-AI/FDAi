...
class SourcePlatformBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = SourcePlatform::class;
    /**
    ...
    public static $group = SourcePlatform::CLASS_CATEGORY;
