...
class OARefreshTokenBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = OARefreshToken::class;
    /**
    ...
    public static $group = OARefreshToken::CLASS_CATEGORY;
