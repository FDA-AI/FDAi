...
class SharerTrusteeBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = SharerTrustee::class;
    /**
    ...
    public static $group = SharerTrustee::CLASS_CATEGORY;
