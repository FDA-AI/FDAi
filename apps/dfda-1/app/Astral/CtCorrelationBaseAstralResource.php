...
class CtCorrelationBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = CtCorrelation::class;
    /**
    ...
    public static $group = CtCorrelation::CLASS_CATEGORY;
