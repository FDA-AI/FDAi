...
class CtConditionTreatmentBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = CtConditionTreatment::class;
    /**
    ...
    public static $group = CtConditionTreatment::CLASS_CATEGORY;
