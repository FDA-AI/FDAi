...
class CtConditionBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = CtCondition::class;
    /**
    ...
    public static $group = CtCondition::CLASS_CATEGORY;
