...
class ButtonClickBaseAstralResource extends BaseAstralAstralResource
{
     ...
     * @var string
     */
    public static $model = ButtonClick::class;
    /**
    ...
    public static $group = ButtonClick::CLASS_CATEGORY;
