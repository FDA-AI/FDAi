...
/** Class BaseAggregateCorrelation
 * @property int $id
 ...
 * @property int $number_of_variables_where_best_aggregate_correlation
 ...
 * @property Collection|Variable[] $variables_where_best_aggregate_correlation
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation newQuery()
 * @method static \Illuminate\Database\Query\Builder|BaseAggregateCorrelation onlyTrashed()
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation query()
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereAggregateQmScore($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereAnalysisEndedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereAnalysisRequestedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereAnalysisStartedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereAverageDailyHighCause($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereAverageDailyLowCause($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereAverageEffect($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation
 *     whereAverageEffectFollowingHighCause($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation
 *     whereAverageEffectFollowingLowCause($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereAverageVote($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation
 *     whereCauseBaselineAveragePerDay($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation
 *     whereCauseBaselineAveragePerDurationOfAction($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereCauseChanges($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation
 *     whereCauseTreatmentAveragePerDay($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation
 *     whereCauseTreatmentAveragePerDurationOfAction($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereCauseUnitId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereCauseVariableCategoryId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereCauseVariableId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereCharts($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereClientId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereConfidenceInterval($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereCriticalTValue($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereDataSourceName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereDeletedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereDeletionReason($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereDurationOfAction($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereEffectBaselineAverage($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation
 *     whereEffectBaselineRelativeStandardDeviation($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation
 *     whereEffectBaselineStandardDeviation($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereEffectChanges($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereEffectFollowUpAverage($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation
 *     whereEffectFollowUpPercentChangeFromBaseline($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereEffectVariableCategoryId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereEffectVariableId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation
 *     whereInterestingVariableCategoryPair($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereInternalErrorMessage($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereNewestDataAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereNumberOfCorrelations($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereNumberOfPairs($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereNumberOfUsers($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation
 *     whereNumberOfVariablesWhereBestAggregateCorrelation($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereOnsetDelay($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereOptimalPearsonProduct($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation wherePValue($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation
 *     wherePopulationTraitPearsonCorrelationCoefficient($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation
 *     wherePredictivePearsonCorrelationCoefficient($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation wherePredictsHighEffectChange($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation wherePredictsLowEffectChange($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation wherePublishedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereReasonForAnalysis($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereRecordSizeInKb($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation
 *     whereReversePearsonCorrelationCoefficient($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereStatisticalSignificance($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereStatus($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereTValue($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereUserErrorMessage($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation
 *     whereValuePredictingHighOutcome($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereValuePredictingLowOutcome($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereWpPostId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|BaseAggregateCorrelation whereZScore($value)
 * @method static \Illuminate\Database\Query\Builder|BaseAggregateCorrelation withTrashed()
 * @method static \Illuminate\Database\Query\Builder|BaseAggregateCorrelation withoutTrashed()
 * @mixin \Eloquent
 */
abstract class BaseAggregateCorrelation extends BaseModel {
	use SoftDeletes;
	use Compoships;
	...
	public const FIELD_NUMBER_OF_VARIABLES_WHERE_BEST_AGGREGATE_CORRELATION = 'number_of_variables_where_best_aggregate_correlation';
	...
	protected $hints = [
		...
		self::FIELD_CHARTS => '',
		self::FIELD_NUMBER_OF_VARIABLES_WHERE_BEST_AGGREGATE_CORRELATION => 'Number of Variables for this Best Aggregate Correlation.
	...
	protected array $relationshipInfo = [
		'cause_unit' => [
			...
			'ownerKey' => AggregateCorrelation::FIELD_CAUSE_UNIT_ID,
		...
		'cause_variable_category' => [
			...
			'ownerKey' => AggregateCorrelation::FIELD_CAUSE_VARIABLE_CATEGORY_ID,
		...
		'cause_variable' => [
			...
			'ownerKey' => AggregateCorrelation::FIELD_CAUSE_VARIABLE_ID,
		...
		'oa_client' => [
			...
			'ownerKey' => AggregateCorrelation::FIELD_CLIENT_ID,
		...
		'effect_variable_category' => [
			...
			'ownerKey' => AggregateCorrelation::FIELD_EFFECT_VARIABLE_CATEGORY_ID,
		...
		'effect_variable' => [
			...
			'ownerKey' => AggregateCorrelation::FIELD_EFFECT_VARIABLE_ID,
		...
		'wp_post' => [
			...
			'ownerKey' => AggregateCorrelation::FIELD_WP_POST_ID,
			'methodName' => 'wp_post',
		],
		...
		'variables_where_best_aggregate_correlation' => [
			'relationshipType' => 'HasMany',
			'qualifiedUserClassName' => Variable::class,
			'foreignKey' => Variable::FIELD_BEST_AGGREGATE_CORRELATION_ID,
			'localKey' => Variable::FIELD_ID,
			'methodName' => 'variables_where_best_aggregate_correlation',
		],
		'votes' => [
			'relationshipType' => 'HasMany',
	...
	public function cause_unit(): BelongsTo{
		return $this->belongsTo(Unit::class, AggregateCorrelation::FIELD_CAUSE_UNIT_ID, Unit::FIELD_ID,
			AggregateCorrelation::FIELD_CAUSE_UNIT_ID);
	}
	public function cause_variable_category(): BelongsTo{
		return $this->belongsTo(VariableCategory::class, AggregateCorrelation::FIELD_CAUSE_VARIABLE_CATEGORY_ID,
			VariableCategory::FIELD_ID, AggregateCorrelation::FIELD_CAUSE_VARIABLE_CATEGORY_ID);
	}
	public function cause_variable(): BelongsTo{
		return $this->belongsTo(Variable::class, AggregateCorrelation::FIELD_CAUSE_VARIABLE_ID, Variable::FIELD_ID,
			AggregateCorrelation::FIELD_CAUSE_VARIABLE_ID);
	}
	...
	public function effect_variable_category(): BelongsTo{
		return $this->belongsTo(VariableCategory::class, AggregateCorrelation::FIELD_EFFECT_VARIABLE_CATEGORY_ID,
			VariableCategory::FIELD_ID, AggregateCorrelation::FIELD_EFFECT_VARIABLE_CATEGORY_ID);
	}
	public function effect_variable(): BelongsTo{
		return $this->belongsTo(Variable::class, AggregateCorrelation::FIELD_EFFECT_VARIABLE_ID, Variable::FIELD_ID,
			AggregateCorrelation::FIELD_EFFECT_VARIABLE_ID);
	}
	public function wp_post(): BelongsTo{
		return $this->belongsTo(WpPost::class, AggregateCorrelation::FIELD_WP_POST_ID, WpPost::FIELD_ID,
			AggregateCorrelation::FIELD_WP_POST_ID);
	}
	...
	public function variables_where_best_aggregate_correlation(): HasMany{
