...
/** Class BaseUserVariableOutcomeCategory
 * @property int $id
 ...
 */
abstract class BaseUserVariableOutcomeCategory extends BaseModel {
	use SoftDeletes;
	public const FIELD_CREATED_AT = 'created_at';
	public const FIELD_DELETED_AT = 'deleted_at';
	public const FIELD_ID = 'id';
	public const FIELD_NUMBER_OF_OUTCOME_USER_VARIABLES = 'number_of_outcome_user_variables';
	...
	public const TABLE = 'user_variable_outcome_category';
	...
	protected $casts = [
		...
		self::FIELD_ID => 'int',
		self::FIELD_NUMBER_OF_OUTCOME_USER_VARIABLES => 'int',
		self::FIELD_USER_VARIABLE_ID => 'int',
		self::FIELD_VARIABLE_CATEGORY_ID => 'int',
		self::FIELD_VARIABLE_ID => 'int',	];
	protected array $rules = [
		self::FIELD_NUMBER_OF_OUTCOME_USER_VARIABLES => 'required|integer|min:0|max:2147483647',
	...
	protected $hints = [
		...
		self::FIELD_NUMBER_OF_OUTCOME_USER_VARIABLES => '',
		self::FIELD_CREATED_AT => 'datetime',
		self::FIELD_UPDATED_AT => 'datetime',
		self::FIELD_DELETED_AT => 'datetime',
	];
	protected array $relationshipInfo = [
		'user_variable' => [
			...
			'ownerKey' => UserVariableOutcomeCategory::FIELD_USER_VARIABLE_ID,
		...
		'variable_category' => [
			...
			'ownerKey' => UserVariableOutcomeCategory::FIELD_VARIABLE_CATEGORY_ID,
		...
		'variable' => [
			...
			'ownerKey' => UserVariableOutcomeCategory::FIELD_VARIABLE_ID,
			'methodName' => 'variable',
		],
	];
	public function user_variable(): BelongsTo{
		return $this->belongsTo(UserVariable::class, UserVariableOutcomeCategory::FIELD_USER_VARIABLE_ID,
			UserVariable::FIELD_ID, UserVariableOutcomeCategory::FIELD_USER_VARIABLE_ID);
	}
	public function variable_category(): BelongsTo{
		return $this->belongsTo(VariableCategory::class, UserVariableOutcomeCategory::FIELD_VARIABLE_CATEGORY_ID,
			VariableCategory::FIELD_ID, UserVariableOutcomeCategory::FIELD_VARIABLE_CATEGORY_ID);
	}
	public function variable(): BelongsTo{
		return $this->belongsTo(Variable::class, UserVariableOutcomeCategory::FIELD_VARIABLE_ID, Variable::FIELD_ID,
			UserVariableOutcomeCategory::FIELD_VARIABLE_ID);
	}
}
