...
build_log_folder=build
phpunit_j_unit_file="build/junit.xml"
go_to_repo_root
clean_folder $build_log_folder
output_enable
...
doppler run -- vendor/phpunit/phpunit/phpunit --configuration phpunit.xml $phpunit_options --filter "$class" --test-suffix ${JOB_NAME}Job.php $QM_API/app/PhpUnitJobs/$FOLDER_NAME
output_disable
