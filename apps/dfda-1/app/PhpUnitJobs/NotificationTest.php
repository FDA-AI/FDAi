...
use App\Notifications\TestNotificationsFeedNotification;
use Mirovit\AstralNotifications\Notification;
class NotificationTest extends \App\PhpUnitJobs\JobTestCase
{
    public function testNotificationsFeed(){
        TestNotificationsFeedNotification::test();
    }
    public function testMiroslavNotification(){
        MiroNotification::test();
    }
    /**
    *
    */
