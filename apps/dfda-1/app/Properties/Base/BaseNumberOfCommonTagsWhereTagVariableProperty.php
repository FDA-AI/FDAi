...
class BaseNumberOfCommonTagsWhereTagVariableProperty extends BaseProperty{
	use IsNumberOfRelated;
	public $dbInput = 'integer,false,true';
	public $dbType = \Doctrine\DBAL\Types\Types::INTEGER;
	public $default = \OpenApi\Generator::UNDEFINED;
	public $description = 'Number of Common Tags for this Tag Variable.
                [Formula:
                    update variables
                        left join (
	...
	public const NAME = 'number_of_common_tags_where_tag_variable';
