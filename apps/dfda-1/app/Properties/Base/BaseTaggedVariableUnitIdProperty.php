...
class BaseTaggedVariableUnitIdProperty extends BaseUnitIdProperty {
	public $dbInput = 'smallInteger,false,true';
	public $dbType = 'smallint';
	public $default = \OpenApi\Generator::UNDEFINED;
	public $description = 'The unit for the source variable to be tagged.';
	public $example = 6;
	...
	public const NAME = 'tagged_variable_unit_id';
