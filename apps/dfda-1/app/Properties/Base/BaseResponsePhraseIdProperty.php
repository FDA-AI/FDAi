...
class BaseResponsePhraseIdProperty extends BaseProperty
{
	...
	public $description = 'response_phrase_id';
	...
	public const NAME = 'response_phrase_id';
	public $order = 99;
	public $phpType = 'int';
	public $rules = 'nullable|integer|min:1|max:2147483647';
	public $showOnDetail = true;
	public $title = 'Response Phrase ID';
