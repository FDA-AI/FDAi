...
class BaseLatestMeasurementStartAtProperty extends BaseProperty{
	use IsDateTime;
	public $dbInput = 'datetime:nullable';
	public $dbType = MySQLTypes::TIMESTAMP;
	public $default = Generator::UNDEFINED;
	public $description = OAClient::FIELD_LATEST_MEASUREMENT_START_AT;
    ...
    public const NAME = OAClient::FIELD_LATEST_MEASUREMENT_START_AT;
    public $name = self::NAME;
	public $phpType = PhpTypes::STRING;
	public $rules = 'nullable|date';
	public $title = 'Latest Measurement Start';
    ...
    public function validate(): void {
        ...
        $this->assertEarliestBeforeLatest($variable->earliest_measurement_start_at, $this->getDBValue());
    }
}
