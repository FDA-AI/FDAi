...
class BaseAnalysisSettingsModifiedAtProperty extends BaseProperty{
	use IsDateTime;
	public $dbInput = 'datetime:nullable';
	public $dbType = \Doctrine\DBAL\Types\Types::DATETIME_MUTABLE;
	public $default = \OpenApi\Generator::UNDEFINED;
	public $description = 'When the analysis settings were last modified';
	public $example = '2019-12-30 02:33:17';
	...
	public const NAME = 'analysis_settings_modified_at';
	public $canBeChangedToNull = true;
	public $phpType = PhpTypes::STRING;
	public $rules = 'nullable|date';
	public $title = 'Analysis Settings Modified';
