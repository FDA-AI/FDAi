...
class BaseStripeActiveProperty extends BaseProperty{
	use IsBoolean, AdminProperty;
	public $dbInput = 'boolean:nullable';
	public $dbType = self::TYPE_BOOLEAN;
	public $default = \OpenApi\Generator::UNDEFINED;
	public $description = 'stripe_active';
	public $example = true;
	public $fieldType = self::TYPE_BOOLEAN;
	public $fontAwesome = FontAwesome::STRIPE_ACTIVE;
	public $htmlInput = 'checkbox,1';
	public $htmlType = 'checkbox';
	public $image = ImageUrls::STRIPE_ACTIVE;
	public $inForm = true;
	public $inIndex = true;
	public $inView = true;
	...
	public const NAME = 'stripe_active';
	public $phpType = PhpTypes::BOOL;
	public $rules = 'nullable|boolean';
	public $title = 'Stripe Active';
