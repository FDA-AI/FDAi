...
class BaseProviderTokenProperty extends BaseProperty{
	use IsString, AdminProperty;
	public $dbInput = 'string,255:nullable';
	public $dbType = PhpTypes::STRING;
	public $default = \OpenApi\Generator::UNDEFINED;
	public $description = 'Access token from provider';
	...
	public const NAME = 'provider_token';
	public $phpType = PhpTypes::STRING;
	public $rules = 'nullable|max:255';
	public $title = 'Provider Token';
