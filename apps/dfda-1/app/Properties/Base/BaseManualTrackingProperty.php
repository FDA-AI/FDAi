...
class BaseManualTrackingProperty extends BaseProperty{
	use IsBoolean;
	public $dbInput = 'boolean:nullable';
	public $dbType = self::TYPE_BOOLEAN;
	public $default = \OpenApi\Generator::UNDEFINED;
	public $description = 'Include manual tracking units in selector when manually recording a measurement. ';
	public $example = true;
	...
	public const NAME = 'manual_tracking';
	public $phpType = PhpTypes::BOOL;
	public $rules = 'nullable|boolean';
	public $title = 'Manual Tracking';
	public $type = self::TYPE_BOOLEAN;
	public $validations = self::TYPE_BOOLEAN;
