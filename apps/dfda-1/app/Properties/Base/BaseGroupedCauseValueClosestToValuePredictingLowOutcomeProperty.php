...
class BaseGroupedCauseValueClosestToValuePredictingLowOutcomeProperty extends BaseProperty{
	use IsFloat;
	...
	public const NAME = 'grouped_cause_value_closest_to_value_predicting_low_outcome';
	public $phpType = 'float';
	public $rules = 'nullable|numeric';
	public $title = 'Grouped Cause Value Closest to Value Predicting Low Outcome';
