...
class BaseLastPushAtProperty extends BaseProperty{
	...
	public $image = ImageUrls::LAST_PUSH_AT;
	public $inForm = true;
	public $inIndex = true;
	public $inView = true;
	...
	public const NAME = 'last_push_at';
	public $phpType = PhpTypes::STRING;
	public $rules = 'nullable|date';
	public $title = 'Last Push';
