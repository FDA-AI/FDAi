...
class BaseLatestTaggedMeasurementStartAtProperty extends BaseProperty{
	use IsDateTime;
    use IsCalculated;
	public $dbInput = 'datetime:nullable';
	public $dbType = MySQLTypes::TIMESTAMP;
	public $default = Generator::UNDEFINED;
	public $description = 'latest_tagged_measurement_start_at';
    ...
    public const NAME = UserVariable::FIELD_LATEST_TAGGED_MEASUREMENT_START_AT;
    public $name = self::NAME;
	public $phpType = PhpTypes::STRING;
	public $rules = 'nullable|date';
	public $title = "Latest Data";
    ...
    public function validate(): void {
        ...
        $val = $this->getDBValue();
        $this->assertEarliestBeforeLatest($uv->earliest_tagged_measurement_start_at, $val);
        if(!$uv->measurementsWithTagsAreSet()){return;}
    ...
    public static function calculate($model){
        ...
        $model->setLatestTaggedMeasurementStartAtAttribute($at);
        return $at;
    }
    public function cannotBeChangedToNull(): bool {
        ...
        if($parent->latest_non_tagged_measurement_start_at){
