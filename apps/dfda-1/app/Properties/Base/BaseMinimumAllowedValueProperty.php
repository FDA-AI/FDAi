...
class BaseMinimumAllowedValueProperty extends BaseValueProperty{
	use IsFloat;
    use \App\Traits\PropertyTraits\IsHyperParameter;
	public $dbInput = 'float,10,0';
	public $dbType = 'float';
	public $default = \OpenApi\Generator::UNDEFINED;
	public $description = 'Minimum reasonable value for this variable (uses default unit)';
	...
	public const NAME = 'minimum_allowed_value';
	public $phpType = 'float';
	public $rules = 'nullable|numeric';
	public $title = 'Minimum Allowed Value';
