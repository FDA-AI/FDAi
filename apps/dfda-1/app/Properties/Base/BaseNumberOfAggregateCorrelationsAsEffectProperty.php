...
class BaseNumberOfAggregateCorrelationsAsEffectProperty extends BaseProperty{
	use IsNumberOfRelated;
	public $dbInput = 'integer,false,true';
	public $dbType = \Doctrine\DBAL\Types\Types::INTEGER;
	public $default = \OpenApi\Generator::UNDEFINED;
	public $description = 'Number of aggregate correlations for which this variable is the effect variable';
	...
	public const NAME = 'number_of_aggregate_correlations_as_effect';
    ...
    public function getIndexField($resolveCallback = null, string $name = null): Field{
        return AggregateCorrelationBaseAstralResource::hasMany("Predictors", 'aggregate_correlations_where_cause_variable');
    }
