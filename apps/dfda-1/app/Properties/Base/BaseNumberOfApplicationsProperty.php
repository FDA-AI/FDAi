...
class BaseNumberOfApplicationsProperty extends BaseProperty{
	use IsNumberOfRelated;
	public $dbInput = 'integer,false,true';
	public $dbType = \Doctrine\DBAL\Types\Types::INTEGER;
	public $default = \OpenApi\Generator::UNDEFINED;
	public $description = 'Number of Applications for this User.
                [Formula:
                    update wp_users
                        left join (
	...
	public $fontAwesome = FontAwesome::APPLICATION;
	public $htmlType = self::TYPE_NUMBER;
	public $image = ImageUrls::APPLICATION;
	public $isOrderable = true;
	public $isSearchable = false;
	public $name = self::NAME;
	public const NAME = 'number_of_applications';
