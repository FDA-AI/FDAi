...
class BaseLastOriginalValueProperty extends BaseOriginalValueProperty{
	use IsFloat;
	public $dbInput = 'float,10,0';
	public $dbType = 'float';
	public $default = \OpenApi\Generator::UNDEFINED;
	public $description = 'Last original value which is stored';
	...
	public const NAME = 'last_original_value';
	public $phpType = 'float';
	public $rules = 'nullable|numeric';
	public $title = 'Last Original Value';
