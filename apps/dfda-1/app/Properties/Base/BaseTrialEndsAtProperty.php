...
class BaseTrialEndsAtProperty extends BaseProperty{
	...
	public const NAME = 'trial_ends_at';
	public $phpType = PhpTypes::STRING;
	public $rules = 'nullable|date';
	public $title = 'Trial Ends';
