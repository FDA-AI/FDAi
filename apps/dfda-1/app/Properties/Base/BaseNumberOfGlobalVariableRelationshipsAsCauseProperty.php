...
class BaseNumberOfGlobalVariableRelationshipsAsCauseProperty extends BaseProperty{
	use IsNumberOfRelated;
	public $dbInput = 'integer,false,true';
	public $dbType = \Doctrine\DBAL\Types\Types::INTEGER;
	public $default = \OpenApi\Generator::UNDEFINED;
	public $description = 'Number of global variable relationships for which this variable is the cause variable';
	...
	public const NAME = 'number_of_global_variable_relationships_as_cause';
    ...
    public function getIndexField($resolveCallback = null, string $name = null): Field{
        return GlobalVariableRelationshipBaseAstralResource::hasMany("Outcomes", 'global_variable_relationships_where_effect_variable');
    }
