...
class BaseNumberOfUserVariableRelationshipsAsEffectProperty extends BaseProperty{
    ...
    public static function getForeignKey(): string{return UserVariableRelationship::FIELD_EFFECT_USER_VARIABLE_ID;}
