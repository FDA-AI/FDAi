...
class BaseExperimentStartTimeProperty extends BaseProperty{
	use IsDateTime;
	public $dbInput = 'datetime:nullable';
	public $dbType = \Doctrine\DBAL\Types\Types::DATETIME_MUTABLE;
	public $default = \OpenApi\Generator::UNDEFINED;
	public $description = 'experiment_start_time';
	...
	public const NAME = 'experiment_start_time';
	public $phpType = PhpTypes::STRING;
	public $rules = 'nullable|date';
	public $title = 'Experiment Start Time';
