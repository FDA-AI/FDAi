...
class AppSettingsTest extends SlimStagingTestCase
{
    ...
    public function testAppSettings(){
        ...
        $appSettings = $responseBody->appSettings;
        MenuItem::checkMenuItems($appSettings);
	...
	public $slimEnvironmentSettings = [
      ...
      'slim.input' => '',
      'slim.request.query_hash' => ['clientId' => 'quantimodo',],
