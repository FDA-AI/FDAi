...
<!-- resources/views/star-rating-popup.blade.php -->
<div class="bg-white min-w-1xl flex flex-col rounded-xl shadow-lg">
    <div class="px-12 py-5">
        <h2 class="text-gray-800 text-3xl font-semibold">{{ $card->getTitleAttribute() }}</h2>
    </div>
    <div class="bg-gray-200 w-full flex flex-col items-center">
        <div class="flex flex-col items-center py-6 space-y-3">
            <span class="text-xl text-gray-800">{{ $card->getSubtitleAttribute() }}</span>
        ...
        <div class="w-3/4 flex flex-col">
            ...
            <button class="py-3 my-8 text-xl bg-gradient-to-r from-purple-500 to-indigo-600 rounded-xl text-white">Rate now</button>
        </div>
    </div>
...
<!-- end resources/views/star-rating-popup.blade.php -->
