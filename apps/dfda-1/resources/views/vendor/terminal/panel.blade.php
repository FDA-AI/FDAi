...
(function() {
    ...
    preload.createElement('link', 'css', '{{ action([\Recca0120\Terminal\Http\Controllers\TerminalController::class, 'media'], ['file' => 'css/terminal.css']) }}');
    preload.createElement('script', 'terminal', '{{ action([\Recca0120\Terminal\Http\Controllers\TerminalController::class, 'media'], ['file' => 'js/terminal.js']) }}', function () {
