...
<p>
    ...
    (R={{ $c->getCorrelationCoefficient(\App\Correlations\QMCorrelation::SIG_FIGS)}})
...
<p>
    ...
    an average {{ $c->causeValueUnitVariableName($c->getDailyValuePredictingLowOutcome()).$c->getPerDaySentenceFragment() }}.
</p>
@endif
@if($c->getDailyValuePredictingLowOutcome() !== null)
<p>
    After an onset delay of {{ $c->getOnsetDelayHumanString() }}, {{ $c->getEffectVariableDisplayName() }} is typically
