...
<div class="form-group col-sm-6">
    ...
    {!! Form::number('average_vote', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::number('aggregate_qm_score', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{{ route('datalab.aggregateCorrelations.index') }}" class="btn btn-default">Cancel</a>
</div>
