create table quantimodo_test.applications
(
    ...
    constraint applications_outcome_variable_id_fk
        foreign key (outcome_variable_id) references quantimodo_test.variables (id),
    constraint applications_predictor_variable_id_fk
        foreign key (predictor_variable_id) references quantimodo_test.variables (id),
