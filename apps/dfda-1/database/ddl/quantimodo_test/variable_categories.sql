create table quantimodo_test.variable_categories
(
    ...
    manual_tracking                              tinyint(1)           default 0                  null comment 'Should we include in manual tracking searches?',
    ...
    comment 'The variable categories include Activity, Causes of
Illness, Cognitive Performance, Conditions, Environment, Foods, Location, Miscellaneous, Mood, Nutrition, Physical Activity, Physique, Sleep, Social Interactions, Symptoms, Treatments, Vital Signs, and Goals.'
    charset = utf8mb3;
