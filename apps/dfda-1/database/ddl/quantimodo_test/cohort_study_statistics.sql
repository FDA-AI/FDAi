create table quantimodo_test.cohort_study_statistics
(
    id                                                           int auto_increment
        primary key,
    cohort_study_id                                              int                                                             null comment 'The related analysis settings and study text associated with these statistics',
    ...
    value_predicting_high_outcome                                double                                                          not null comment 'cause value that predicts an above average Outcome value (in default unit for Predictor variable)',
    value_predicting_low_outcome                                 double                                                          not null comment 'cause value that predicts a below average Outcome value (in default unit for Predictor variable)',
    ...
    number_of_participants                                       int                                                             not null comment 'Number of participants',
    statistical_significance                                     float(10, 4)                                                    not null comment 'A function of the effect size and sample size',
    cause_unit_id                                                smallint unsigned                                               null comment 'Unit ID of Predictor Variable',
    cause_changes                                                int                                                             not null comment 'The number of times the Predictor measurement value was different from the one preceding it.',
    effect_changes                                               int                                                             not null comment 'The number of times the Outcome measurement value was different from the one preceding it.',
    Cohort_qm_score                                              double                                                          not null comment 'A number representative of the relative importance of the relationship based on the strength, usefulness, and plausible causality.  The higher the number, the greater the perceived importance.  This value can be used for sorting relationships by importance. ',
    ...
    predicts_low_effect_change                                   int                                                             not null comment 'The percent change in the outcome from average typically seen when the predictor value is closer to the predictsHighEffect value.',
    ...
    average_effect_following_high_cause                          double                                                          not null comment 'The average Outcome variable measurement value following an above average Predictor value (in the common unit). ',
    average_effect_following_low_cause                           double                                                          not null comment 'The average Outcome variable measurement value following a below average Predictor value (in the common unit). ',
    average_daily_low_cause                                      double                                                          not null comment 'The average of below average Predictor values (in the common unit). ',
    average_daily_high_cause                                     double                                                          not null comment 'The average of above average Predictor values (in the common unit). ',
    ...
    analysis_started_at                                          timestamp   default '0000-00-00 00:00:00'                       not null,
    ...
    constraint cohort_study_statistics_cause_variable_category_id_fk
        foreign key (cause_variable_category_id) references quantimodo_test.variable_categories (id),
    ...
    constraint cohort_study_statistics_effect_variable_category_id_fk
        foreign key (effect_variable_category_id) references quantimodo_test.variable_categories (id),
    ...
    comment 'Stores Calculated Cohort Study Statistics' charset = utf8mb3;

create index cohort_study_statistics_effect_variable_id_index
    on quantimodo_test.cohort_study_statistics (effect_variable_id);
