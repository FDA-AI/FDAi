create table quantimodo_test.ct_condition_symptom
(
    ...
    constraint ct_condition_symptom_symptoms_fk
        foreign key (symptom_id) references quantimodo_test.ct_symptoms (id),
    ...
    constraint ct_condition_symptom_variables_symptom_fk
        foreign key (symptom_variable_id) references quantimodo_test.variables (id)
)
    charset = utf8mb3;
