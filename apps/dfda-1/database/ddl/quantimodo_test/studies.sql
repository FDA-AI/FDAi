create table quantimodo_test.studies
(
    ...
    comment 'Stores Study Settings' charset = utf8mb3;

create index cause_variable_id
    on quantimodo_test.studies (cause_variable_id);

create index effect_variable_id
    on quantimodo_test.studies (effect_variable_id);
