create table quantimodo_test.global_studies
(
    ...
    effect_user_variable_id       int unsigned                          not null comment 'Variable ID of the outcome variable',
    ...
    comment 'Global Study Analysis Settings and Written Text' charset = utf8mb3;

create index global_studies_cause_variable_id
    on quantimodo_test.global_studies (cause_variable_id);

create index global_studies_effect_variable_id
    on quantimodo_test.global_studies (effect_variable_id);
