create table quantimodo_test.oa_clients
(
    ...
    constraint oa_clients_user_id_fk
        foreign key (user_id) references quantimodo_test.wp_users (ID)
)
    comment 'OAuth client applications that can modify data on behalf of the data owner' charset = utf8mb3;
