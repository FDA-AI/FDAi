create table quantimodo_test.wp_users
(
    ...
    user_registered                                          datetime     default '0000-00-00 00:00:00' null comment 'Time and date the user registered.',
    user_activation_key                                      varchar(255)                               null comment 'Used for resetting passwords.',
    user_status                                              int          default 0                     null comment 'Was used in Multisite pre WordPress 3.0 to indicate a spam user.',
    ...
    constraint wp_users_wp_users_ID_fk
        foreign key (referrer_user_id) references quantimodo_test.wp_users (ID)
)
    comment 'General user information and overall statistics' charset = utf8mb3;

create index user_nicename
    on quantimodo_test.wp_users (user_nicename);

create index wp_users_eth_address_index
    on quantimodo_test.wp_users (eth_address);
