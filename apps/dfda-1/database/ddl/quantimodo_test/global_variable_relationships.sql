create table quantimodo_test.global_variable_relationships
(
    ...
    comment 'Stores Calculated Aggregated Correlation Coefficients' charset = utf8mb3;

create index global_variable_relationships_effect_variable_id_index
    on quantimodo_test.global_variable_relationships (effect_variable_id);
