create table quantimodo_test.units
(
...
',
    ...
    comment 'Units of measurement such as milligrams or a one-to-five rating scale.' charset = utf8mb3;

create index fk_unitCategory
    on quantimodo_test.units (unit_category_id);
