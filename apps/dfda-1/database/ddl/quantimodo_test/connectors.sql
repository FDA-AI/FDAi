create table quantimodo_test.connectors
(
    id                           int unsigned auto_increment comment 'Connector ID number'
        primary key,
    ...
    available_outside_us         tinyint(1) default 1                 not null,
    ...
    comment 'Data sources that provide measurements via API or screen scraping' charset = utf8mb3;
