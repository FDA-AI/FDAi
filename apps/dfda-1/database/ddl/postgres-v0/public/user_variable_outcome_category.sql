...
(
    ...
    number_of_outcome_user_variables integer                                not null,
    created_at                       timestamp(0) default CURRENT_TIMESTAMP not null,
    updated_at                       timestamp(0) default CURRENT_TIMESTAMP not null,
    deleted_at                       timestamp(0),
    constraint user_variable_outcome_category_uindex
...
create index user_variable_outcome_category_variables_id_fk
    on user_variable_outcome_category (variable_id);

create index user_variable_outcome_category_variable_categories_id_fk
    on user_variable_outcome_category (variable_category_id);
