    ...
    public function run()
    {
        ...
        \DB::table('aggregate_correlations')->insert(array (
            ...
            array (
                ...
                'z_score' => '1.06',
            'charts' => '{"populationTraitScatterPlot":{"chartId":"trait-correlation-between-bupropion-sr-intake-and-overall-mood","chartTitle":"Trait Correlation Between Bupropion Sr Intake and Overall Mood","explanation":"People with higher Bupropion Sr Intake usually have lower Overall Mood","highchartConfig":{"chart":{"renderTo":"trait-correlation-between-bupropion-sr-intake-and-overall-mood-chart-container","type":"scatter","zoomType":"xy"},"title":{"text":"Trait Correlation Between Bupropion Sr Intake and Overall Mood","enabled":true},"subtitle":{"text":"People with higher Bupropion Sr Intake usually have lower Overall Mood"},"xAxis":{"title":{"text":"Average Bupropion Sr Intake (mg) for Participant"}},"yAxis":{"title":{"text":"Average Overall Mood (\\/5) for Participant","enabled":true}},"legend":{"enabled":true},"series":[{"name":"Overall Mood by Bupropion Sr","data":[[75,3]],"marker":{"enabled":true,"radius":5},"color":"#000000","visible":true}],"tooltip":{"formatter":{"_expression":"function() {\\n            var series = this.series || this.points[0].series || this.points[0].chart.series;\\n            var tooltips = series.options.tooltips;\\n            if(tooltips){\\n                var x = this.x || this.point.x\\n                var tooltip = tooltips[x] || null;\\n                if(tooltip){\\n                    \\/\\/console.warn(this.point)\\n                    \\/\\/debugger\\n                    return tooltip\\n                }\\n            }\\n            \\n            return \'People with an average of \' + this.x +\\n                \'mg Bupropion Sr<br\\/> typically exhibit an average of <br\\/>\' +\\n                this.y + \'\\/5 Overall Mood\';\\n        \\n        }"}},"colors":["#000000","#3467d6","#dd4b39","#0f9d58","#f09402","#d34836","#886aea"],"credits":{"enabled":false},"lang":{"loading":""},"loading":{"hideDuration":10,"showDuration":10},"plotOptions":{"scatter":{"tooltip":{"formatter":{"_expression":"function() {\\n            var series = this.series || this.points[0].series || this.points[0].chart.series;\\n            var tooltips = series.options.tooltips;\\n            if(tooltips){\\n                var x = this.x || this.point.x\\n                var tooltip = tooltips[x] || null;\\n                if(tooltip){\\n                    \\/\\/console.warn(this.point)\\n                    \\/\\/debugger\\n                    return tooltip\\n                }\\n            }\\n            \\n            return \'People with an average of \' + this.x +\\n                \'mg Bupropion Sr<br\\/> typically exhibit an average of <br\\/>\' +\\n                this.y + \'\\/5 Overall Mood\';\\n        \\n        }"}}}},"useHighStocks":false,"exporting":{"enabled":true},"id":"trait-correlation-between-bupropion-sr-intake-and-overall-mood","themeName":"white","divHeight":null,"type":"Population Trait Correlation Scatter Plot"},"id":"trait-correlation-between-bupropion-sr-intake-and-overall-mood","imageGeneratedAt":null,"imageUrl":null,"jpgUrl":null,"pngUrl":null,"subtitle":null,"svgUrl":null,"title":"Trait Correlation Between Bupropion Sr Intake and Overall Mood","validImageOnS3":null,"variableName":null},"id":null}',
