...
class CreateTrackingReminderNotificationsTable extends Migration
{
    ...
    public function up()
    {
         Schema::create('tracking_reminder_notifications', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('tracking_reminder_id')->index('tracking_reminder_notifications_tracking_reminders_id_fk');
            $table->timestamp('created_at')->useCurrent();
            $table->timestamp('updated_at')->useCurrent();
            $table->softDeletes();
            $table->bigInteger('user_id')->index('tracking_reminder_notifications_user_id_fk');
            ...
            $table->integer('variable_id')->index('tracking_reminder_notifications_variable_id_fk');
            $table->timestamp('notify_at')->nullable();
            $table->integer('user_variable_id')->index('tracking_reminder_notifications_user_variables_id_fk');
