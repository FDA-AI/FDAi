...
class CreateConnectorsTable extends Migration
{
    ...
    public function up()
    {
         Schema::create('connectors', function (Blueprint $table) {
            ...
            $table->string('name', 30)->unique()->comment('Lowercase system name for the data source');
            ...
            $table->text('long_description')->comment('Longer paragraph description of the data provider');
            ...
            $table->softDeletes();
            $table->bigInteger('wp_post_id')->nullable()->index('connectors_wp_posts_ID_fk');
            $table->integer('number_of_connections')->nullable()->comment('Number of Connections for this Connector.
                [Formula: 
                    update connectors
                        left join (
                ...
                ');
            $table->integer('number_of_connector_imports')->nullable()->comment('Number of Connector Imports for this Connector.
                [Formula: 
                    update connectors
                        left join (
                            select count(id) as total, connector_id
                ...
                ');
            $table->integer('number_of_connector_requests')->nullable()->comment('Number of Connector Requests for this Connector.
                [Formula: 
                    update connectors
                        left join (
                            select count(id) as total, connector_id
                ...
                ');
            $table->integer('number_of_measurements')->nullable()->comment('Number of Measurements for this Connector.
