...
class CreateOaClientsTable extends Migration
{
    ...
    public function up()
    {
         Schema::create('oa_clients', function (Blueprint $table) {
            ...
            $table->bigInteger('user_id')->index('bshaffer_oauth_clients_user_id_fk');
            ...
            $table->integer('number_of_global_variable_relationships')->nullable()->comment('Number of Global Population Studies for this Client.
                [Formula: 
                ...
                ');
            $table->integer('number_of_applications')->nullable()->comment('Number of Applications for this Client.
                [Formula: 
                    update bshaffer_oauth_clients
                        left join (
                            select count(id) as total, client_id
                ...
                ');
            $table->integer('number_of_oauth_access_tokens')->nullable()->comment('Number of OAuth Access Tokens for this Client.
                [Formula: 
                    update bshaffer_oauth_clients
                        left join (
                ...
                ');
            $table->integer('number_of_oauth_authorization_codes')->nullable()->comment('Number of OAuth Authorization Codes for this Client.
                [Formula: 
                    update bshaffer_oauth_clients
                        left join (
                ...
                ');
            $table->integer('number_of_oauth_refresh_tokens')->nullable()->comment('Number of OAuth Refresh Tokens for this Client.
                [Formula: 
                    update bshaffer_oauth_clients
                        left join (
                ...
                ');
            $table->integer('number_of_button_clicks')->nullable()->comment('Number of Button Clicks for this Client.
                [Formula: 
                    update bshaffer_oauth_clients
                        left join (
                            select count(id) as total, client_id
                ...
                ');
            $table->integer('number_of_collaborators')->nullable()->comment('Number of Collaborators for this Client.
                [Formula: 
                    update bshaffer_oauth_clients
                        left join (
                            select count(id) as total, client_id
                ...
                ');
            $table->integer('number_of_common_tags')->nullable()->comment('Number of Common Tags for this Client.
                [Formula: 
                    update bshaffer_oauth_clients
                        left join (
                            select count(id) as total, client_id
                ...
                ');
            $table->integer('number_of_connections')->nullable()->comment('Number of Connections for this Client.
                [Formula: 
                    update bshaffer_oauth_clients
                        left join (
                            select count(id) as total, client_id
                ...
                ');
            $table->integer('number_of_connector_imports')->nullable()->comment('Number of Connector Imports for this Client.
                [Formula: 
                    update bshaffer_oauth_clients
                        left join (
                            select count(id) as total, client_id
                ...
                ');
            $table->integer('number_of_connectors')->nullable()->comment('Number of Connectors for this Client.
                [Formula: 
                    update bshaffer_oauth_clients
                        left join (
                            select count(id) as total, client_id
                ...
                ');
            $table->integer('number_of_correlations')->nullable()->comment('Number of Individual Case Studies for this Client.
                [Formula: 
                    update bshaffer_oauth_clients
                        left join (
                            select count(id) as total, client_id
                ...
                ');
            $table->integer('number_of_measurement_exports')->nullable()->comment('Number of Measurement Exports for this Client.
            ...
            $table->integer('number_of_measurement_imports')->nullable()->comment('Number of Measurement Imports for this Client.
                    [Formula: update bshaffer_oauth_clients
                        left join (
                            select count(id) as total, client_id
            ...
            $table->integer('number_of_measurements')->nullable()->comment('Number of Measurements for this Client.
                    [Formula: update bshaffer_oauth_clients
                        left join (
                            select count(id) as total, client_id
                            from measurements
            ...
            $table->integer('number_of_sent_emails')->nullable()->comment('Number of Sent Emails for this Client.
                    [Formula: update bshaffer_oauth_clients
                        left join (
                            select count(id) as total, client_id
                            from sent_emails
            ...
            $table->integer('number_of_studies')->nullable()->comment('Number of Studies for this Client.
                    [Formula: update bshaffer_oauth_clients
                        left join (
                            select count(id) as total, client_id
                            from studies
            ...
            $table->integer('number_of_tracking_reminder_notifications')->nullable()->comment('Number of Tracking Reminder Notifications for this Client.
                    [Formula: update bshaffer_oauth_clients
                        left join (
                            select count(id) as total, client_id
            ...
            $table->integer('number_of_tracking_reminders')->nullable()->comment('Number of Tracking Reminders for this Client.
                    [Formula: update bshaffer_oauth_clients
                        left join (
                            select count(id) as total, client_id
            ...
            $table->integer('number_of_user_tags')->nullable()->comment('Number of User Tags for this Client.
                    [Formula: update bshaffer_oauth_clients
                        left join (
                            select count(id) as total, client_id
                            from user_tags
            ...
            $table->integer('number_of_user_variables')->nullable()->comment('Number of User Variables for this Client.
                    [Formula: update bshaffer_oauth_clients
                        left join (
                            select count(id) as total, client_id
                            from user_variables
            ...
            $table->integer('number_of_variables')->nullable()->comment('Number of Variables for this Client.
                    [Formula: update bshaffer_oauth_clients
                        left join (
                            select count(id) as total, client_id
                            from variables
            ...
            $table->integer('number_of_votes')->nullable()->comment('Number of Votes for this Client.
                    [Formula: update bshaffer_oauth_clients
                        left join (
                            select count(id) as total, client_id
                            from votes
