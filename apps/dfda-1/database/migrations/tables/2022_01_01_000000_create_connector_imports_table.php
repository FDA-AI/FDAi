...
class CreateConnectorImportsTable extends Migration
{
    ...
    public function up()
    {
         Schema::create('connector_imports', function (Blueprint $table) {
            ...
            $table->integer('number_of_measurements')->default(0);
            ...
            $table->integer('number_of_connector_requests')->nullable()->comment('Number of Connector Requests for this Connector Import.
                [Formula: 
