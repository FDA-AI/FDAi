...
class CreateWpTermRelationshipsTable extends Migration
{
    ...
    public function up()
    {
         Schema::create('wp_term_relationships', function (Blueprint $table) {
            $table->bigInteger('object_id')->comment('The ID of the post object.');
            $table->bigInteger('term_taxonomy_id')->index('term_taxonomy_id')->comment('The ID of the term / taxonomy pair.');
