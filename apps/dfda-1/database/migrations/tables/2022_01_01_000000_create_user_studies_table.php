...
class CreateUserStudiesTable extends Migration
{
    ...
    public function up()
    {
         Schema::create('user_studies', function (Blueprint $table) {
            ...
            $table->integer('cause_variable_id')->index('user_studies_cause_variables_id_fk')->comment('variable ID of the cause variable for which the user desires correlations');
            $table->integer('effect_variable_id')->index('user_studies_effect_variables_id_fk')->comment('variable ID of the effect variable for which the user desires correlations');
            $table->integer('cause_user_variable_id')->index('user_studies_cause_user_variables_id_fk')->comment('variable ID of the cause variable for which the user desires correlations');
            $table->integer('effect_user_variable_id')->index('user_studies_effect_user_variables_id_fk')->comment('variable ID of the effect variable for which the user desires correlations');
