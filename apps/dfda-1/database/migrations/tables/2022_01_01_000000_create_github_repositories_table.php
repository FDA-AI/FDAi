...
class CreateGithubRepositoriesTable extends Migration
{
    ...
    public function up()
    {
         Schema::create('github_repositories', function (Blueprint $table) {
            $table->integer('id')->unique('github_repositories_id_uindex')->comment('Automatically generated unique id for the github repository');
            ...
            $table->text('owner')->comment('Example: login:mikepsinn,id:2808553,node_id:MDQ6VXNlcjI4MDg1NTM=,avatar_url:https://avatars.githubusercontent.com/u/2808553?v=4,gravatar_id:,url:https://api.github.com/users/mikepsinn,html_url:https://github.com/mikepsinn,followers_url:https://api.github.com/users/mikepsinn/followers,following_url:https://api.github.com/users/mikepsinn/following/other_user,gists_url:https://api.github.com/users/mikepsinn/gists/gist_id,starred_url:https://api.github.com/users/mikepsinn/starred/owner/repo,subscriptions_url:https://api.github.com/users/mikepsinn/subscriptions,organizations_url:https://api.github.com/users/mikepsinn/orgs,repos_url:https://api.github.com/users/mikepsinn/repos,events_url:https://api.github.com/users/mikepsinn/events/privacy,received_events_url:https://api.github.com/users/mikepsinn/received_events,type:User,site_admin:false');
            $table->string('html_url')->unique('github_repositories_html_url_uindex')->comment('Example: https://github.com/mikepsinn/qm-api');
            $table->text('description')->nullable()->comment('Example: I\'m a description');
            ...
            $table->text('topics')->comment('Example: [digital-health,health,healthcare-data]');
            ...
            $table->text('permissions')->comment('Example: admin:true,maintain:true,push:true,triage:true,pull:true');
            $table->string('temp_clone_token')->nullable()->comment('Example: AAVNV2SECRETYTBOS7ZI');
            $table->boolean('allow_squash_merge')->nullable()->comment('Example: 1');
            $table->boolean('allow_merge_commit')->nullable()->comment('Example: 1');
            $table->boolean('allow_rebase_merge')->nullable()->comment('Example: 1');
            $table->boolean('allow_auto_merge')->nullable()->comment('Example: ');
            $table->boolean('delete_branch_on_merge')->nullable()->comment('Example: ');
            $table->integer('network_count')->nullable()->comment('Example: 0');
            $table->integer('subscribers_count')->nullable()->comment('Example: 0');
            ...
            $table->text('license')->nullable()->comment('GPL-3.0');
            $table->boolean('web_commit_signoff_required')->nullable()->comment('Example: false');
        });
    }
