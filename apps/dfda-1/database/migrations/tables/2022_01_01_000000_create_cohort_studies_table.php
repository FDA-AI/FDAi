...
class CreateCohortStudiesTable extends Migration
{
    ...
    public function up()
    {
         Schema::create('cohort_studies', function (Blueprint $table) {
            ...
            $table->integer('cause_variable_id')->index('cause_variable_id')->comment('Variable ID of the predictor variable');
            $table->integer('effect_variable_id')->index('cohort_studies_effect_variable_id')->comment('Variable ID of the outcome variable');
