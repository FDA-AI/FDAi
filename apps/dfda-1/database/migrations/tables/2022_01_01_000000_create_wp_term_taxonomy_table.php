...
class CreateWpTermTaxonomyTable extends Migration
{
    ...
    public function up()
    {
         Schema::create('wp_term_taxonomy', function (Blueprint $table) {
            ...
            $table->bigInteger('term_id')->nullable()->comment('The ID of the related term.');
            ...
            $table->text('description')->nullable()->comment('Description of the term in this taxonomy.');
            $table->bigInteger('parent')->nullable()->comment('ID of a parent term. Used for hierarchical taxonomies like Categories.');
