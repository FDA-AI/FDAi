...
class CreateSpreadsheetImportersTable extends Migration
{
    ...
    public function up()
    {
         Schema::create('spreadsheet_importers', function (Blueprint $table) {
            ...
            $table->softDeletes();
            $table->bigInteger('wp_post_id')->nullable()->index('spreadsheet_importers_wp_posts_ID_fk');
            $table->integer('number_of_measurement_imports')->nullable()->comment('Number of Spreadsheet Import Requests for this Spreadsheet Importer.
                            [Formula:
                            ...
                            ');
            $table->integer('number_of_measurements')->nullable()->comment('Number of Measurements for this Spreadsheet Importer.
