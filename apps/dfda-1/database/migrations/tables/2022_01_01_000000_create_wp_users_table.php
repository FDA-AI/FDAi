...
class CreateWpUsersTable extends Migration
{
    ...
    public function up()
    {
         Schema::create('wp_users', function (Blueprint $table) {
            $table->increments('ID')->comment('Unique number assigned to each user.');
            $table->string('client_id');
            $table->string('user_login', 60)->nullable()->unique('user_login_key')->comment('Unique username for the user.');
            $table->string('user_email', 320)->nullable()->unique('user_email')->comment('Email address of the user.');
            ...
            $table->string('user_url', 2083)->nullable();
            $table->timestamp('user_registered')->nullable()->comment('Time and date the user registered.');
            ...
            $table->enum('subscription_provider', ['stripe', 'apple', 'google', null])->nullable();
            $table->bigInteger('last_sms_tracking_reminder_notification_id')->nullable();
            ...
            $table->bigInteger('referrer_user_id')->nullable()->index('wp_users_wp_users_ID_fk');
            ...
            $table->integer('primary_outcome_variable_id')->nullable()->index('wp_users_variables_id_fk');
            $table->smallInteger('spam')->default(0);
            $table->smallInteger('deleted')->default(0);
            $table->bigInteger('wp_post_id')->nullable()->index('wp_users_wp_posts_ID_fk');
            ...
            $table->integer('number_of_applications')->nullable()->comment('Number of Applications for this User.
                [Formula: 
                    update wp_users
                        left join (
                ...
                ');
            $table->integer('number_of_oauth_access_tokens')->nullable()->comment('Number of OAuth Access Tokens for this User.
                [Formula: 
                    update wp_users
                        left join (
                ...
                ');
            $table->integer('number_of_oauth_authorization_codes')->nullable()->comment('Number of OAuth Authorization Codes for this User.
                [Formula: 
                    update wp_users
                        left join (
                ...
                ');
            $table->integer('number_of_oauth_clients')->nullable()->comment('Number of OAuth Clients for this User.
                [Formula: 
                    update wp_users
                        left join (
                ...
                ');
            $table->integer('number_of_oauth_refresh_tokens')->nullable()->comment('Number of OAuth Refresh Tokens for this User.
                [Formula: 
                    update wp_users
                        left join (
                ...
                ');
            $table->integer('number_of_button_clicks')->nullable()->comment('Number of Button Clicks for this User.
                [Formula: 
                    update wp_users
                        left join (
                            select count(id) as total, user_id
                ...
                ');
            $table->integer('number_of_collaborators')->nullable()->comment('Number of Collaborators for this User.
                [Formula: 
                    update wp_users
                        left join (
                            select count(id) as total, user_id
                ...
                ');
            $table->integer('number_of_connector_imports')->nullable()->comment('Number of Connector Imports for this User.
                [Formula: 
                    update wp_users
                        left join (
                            select count(id) as total, user_id
                ...
                ');
            $table->integer('number_of_connector_requests')->nullable()->comment('Number of Connector Requests for this User.
                [Formula: 
                    update wp_users
                        left join (
                            select count(id) as total, user_id
                ...
                ');
            $table->integer('number_of_measurement_exports')->nullable()->comment('Number of Measurement Exports for this User.
            ...
            $table->integer('number_of_measurement_imports')->nullable()->comment('Number of Measurement Imports for this User.
                    [Formula: update wp_users
                        left join (
                            select count(id) as total, user_id
            ...
            $table->integer('number_of_measurements')->nullable()->comment('Number of Measurements for this User.
                    [Formula: update wp_users
                        left join (
                            select count(id) as total, user_id
                            from measurements
            ...
            $table->integer('number_of_sent_emails')->nullable()->comment('Number of Sent Emails for this User.
                    [Formula: update wp_users
                        left join (
                            select count(id) as total, user_id
                            from sent_emails
            ...
            $table->integer('number_of_subscriptions')->nullable()->comment('Number of Subscriptions for this User.
                    [Formula: update wp_users
                        left join (
                            select count(id) as total, user_id
                            from subscriptions
            ...
            $table->integer('number_of_tracking_reminder_notifications')->nullable()->comment('Number of Tracking Reminder Notifications for this User.
                    [Formula: update wp_users
                        left join (
                            select count(id) as total, user_id
            ...
            $table->integer('number_of_user_tags')->nullable()->comment('Number of User Tags for this User.
                    [Formula: update wp_users
                        left join (
                            select count(id) as total, user_id
                            from user_tags
            ...
            $table->integer('number_of_users_where_referrer_user')->nullable()->comment('Number of Users for this Referrer User.
                    [Formula: update wp_users
                        left join (
            ...
            $table->integer('number_of_sharers')->nullable()->comment('Number of people sharing their data with you.');
            $table->integer('number_of_trustees')->nullable()->comment('Number of people that you are sharing your data with.');
