...
class CreateConnectionsTable extends Migration
{
    ...
    public function up()
    {
         Schema::create('connections', function (Blueprint $table) {
            ...
            $table->integer('connector_id')->index('connections_connectors_id_fk')->comment('The id for the connector data source for which the connection is connected');
            ...
            $table->bigInteger('wp_post_id')->nullable()->index('connections_wp_posts_ID_fk');
            $table->integer('number_of_connector_imports')->nullable()->comment('Number of Connector Imports for this Connection.
                [Formula: 
                    update connections
                        left join (
                ...
                ');
            $table->integer('number_of_connector_requests')->nullable()->comment('Number of Connector Requests for this Connection.
                [Formula: 
                    update connections
                        left join (
                            select count(id) as total, connection_id
            ...
            $table->integer('number_of_measurements')->nullable()->comment('Number of Measurements for this Connection.
