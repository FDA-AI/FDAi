...
class CreateUnitsTable extends Migration
{
    ...
    public function up()
    {
         Schema::create('units', function (Blueprint $table) {
            ...
            $table->smallInteger('unit_category_id')->index('fk_unitCategory')->comment('Unit category ID');
            $table->float('minimum_value', 0, 0)->nullable()->comment('The minimum value for a single measurement. ');
            $table->float('maximum_value', 0, 0)->nullable()->comment('The maximum value for a single measurement');
            ...
            $table->integer('number_of_outcome_population_studies')->nullable()->comment('Number of Global Population Studies for this Cause Unit.
                [Formula: 
                    update units
                        left join (
                ...
                ');
            $table->integer('number_of_common_tags_where_tag_variable_unit')->nullable()->comment('Number of Common Tags for this Tag Variable Unit.
                [Formula: 
                    update units
                        left join (
                ...
                ');
            $table->integer('number_of_common_tags_where_tagged_variable_unit')->nullable()->comment('Number of Common Tags for this Tagged Variable Unit.
                [Formula: 
                    update units
                        left join (
                ...
                ');
            $table->integer('number_of_outcome_case_studies')->nullable()->comment('Number of Individual Case Studies for this Cause Unit.
                [Formula: 
                    update units
                        left join (
                            select count(id) as total, cause_unit_id
                ...
                ');
            $table->integer('number_of_measurements')->nullable()->comment('Number of Measurements for this Unit.
            ...
            $table->integer('number_of_user_variables_where_default_unit')->nullable()->comment('Number of User Variables for this Default Unit.
                    [Formula: update units
                        left join (
            ...
            $table->integer('number_of_variable_categories_where_default_unit')->nullable()->comment('Number of Variable Categories for this Default Unit.
                    [Formula: update units
                        left join (
                            select count(id) as total, default_unit_id
            ...
            $table->integer('number_of_variables_where_default_unit')->nullable()->comment('Number of Variables for this Default Unit.
                    [Formula: update units
                        left join (
                            select count(id) as total, default_unit_id
                            from variables
            ...
            $table->float('filling_value', 0, 0)->nullable()->comment('The filling value is substituted used when data is missing if the filling type is set to value.');
...
');
            ...
            $table->float('maximum_daily_value', 0, 0)->nullable()->comment('The maximum aggregated measurement value over a single day.');
