    ...
    public function validateAuthorizeRequest(RequestInterface $request, ResponseInterface $response)
    {
        ...
        if ($supplied_redirect_uri = $request->query('redirect_uri')) {
            ...
            if ($registered_redirect_uri && !$this->validateRedirectUri($supplied_redirect_uri, $registered_redirect_uri)) {
                $supplied_redirect_uri = \App\Utils\Env::getAppUrl().'/api/v1/connectors/quantimodo/connect';
                // TODO: Maybe remove this override after clients are updated to supply redirect URI
