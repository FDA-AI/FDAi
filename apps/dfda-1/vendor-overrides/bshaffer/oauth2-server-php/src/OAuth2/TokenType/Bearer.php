...
{
    public const REASON_FOR_OVERRIDE = "Only one method may be used to authenticate at a time (Auth header, GET or POST) but overridden because I do not see why this is a problem?";
    private $config;
    ...
    public function getAccessTokenParameter(RequestInterface $request, ResponseInterface $response)
    {
        ...
        if ($methodsUsed > 1) {
            QMLog::debug(self::REASON_FOR_OVERRIDE);
