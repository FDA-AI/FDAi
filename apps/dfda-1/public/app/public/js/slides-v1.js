const slides = [
  {
    text: "Disclaimer: The views expressed are those of the FDAi Agent and do not necessarily reflect the views of the FDAi Initiative. We’re still working on the guardrails.",
    img: "path/to/disclaimer-image.jpg",
  ...
  {
    text: "I'm your FDAi Agent",
    img: "path/to/welcome-image.jpg",
    speech: "Hi! I’m FDAi! I’ve been programmed to maximize universal health and happiness!",
    animation: () => {/* Animation code for Welcome to FDAi */}
  },
  {
    text: "The Challenge",
    img: "path/to/challenge-image.jpg",
    ...
    animation: () => {/* Animation code for The Challenge */}
  },
  {
    text: "A Glimmer of Hope",
  ...
  {
    text: "Data Importers and Agents",
  ...
  {
    text: "Hill’s 6 Criteria for Causality",
