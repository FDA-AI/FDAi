...
describe('Strategy', function() {
  ...
  describe('constructed', function() {
    ...
    it('should be named quantimodo', function() {
      expect(strategy.name).to.equal('quantimodo');
    });
  });
  ...
  describe('authorization request without options', function() {
    ...
    it('should be redirected', function() {
      expect(url).to.equal('https://app.quantimo.do/oauth/authorize?response_type=code&client_id=ABC123');
    });
  });
  ...
  describe('authorization request with extra parameters', function() {
    ...
    it('should be redirected', function() {
      expect(url).to.equal('https://app.quantimo.do/oauth/authorize?foo=bar&response_type=code&client_id=ABC123');
    });
  });
  ...
  describe('authorization request with scopes', function() {
    ...
    it('should be redirected', function() {
      expect(url).to.equal('https://app.quantimo.do/oauth/authorize?scope=weight%20profile&response_type=code&client_id=ABC123');
    });
  });
