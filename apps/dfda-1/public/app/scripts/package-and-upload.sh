...
if [ -f ${APP_DISPLAY_NAME}.xcworkspace ];
then
   echo "Found ${APP_DISPLAY_NAME}.xcworkspace generated by pod install"
else
   echo "ERROR: ${APP_DISPLAY_NAME}.xcworkspace does not exist. Build FAILED. Did you mean to run pod install?"
   exit 1
fi
