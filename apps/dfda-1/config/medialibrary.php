<?php
use App\Files\CustomPathGenerator;
...
return [
     ...
     */
    'disk_name' => env('MEDIA_DISK', S3Private::DISK_NAME),
    ...
    's3' => [
         ...
         */
        //'domain' => 'https://'.env('STORAGE_BUCKET').'.s3.amazonaws.com',
        'domain' => env('APP_URL').'api/v1/static',
    ],
