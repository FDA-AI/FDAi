    ...
    */
    ...
    '*' => [
        ...
        */
        ...
        'use' => [
            // App\CodeGenerators\ModelGenerator\Database\Eloquent\BitBooleans::class,
            // App\CodeGenerators\ModelGenerator\Database\Eloquent\BlamableBehavior::class,
        ],
        ...
        */
        ...
        'casts' => [
            ...
            'json_encoded'                     => 'json',
            Variable::FIELD_DATA_SOURCES_COUNT => 'json',
            \App\Models\User::FIELD_EARLIEST_REMINDER_TIME => "string",
            \App\Models\User::FIELD_LATEST_REMINDER_TIME => "string",
            BaseModel::FIELD_DELETED_AT => "date",
        ],
        ...
        |
        */
        'except' => QMDB::TABLES_TO_EXCLUDE_FROM_MODEL_GENERATION,
...
//            'wp_termmeta',
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | Make table column comments available in models
        |
        */
