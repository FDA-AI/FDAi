...
return [
	...
	*/
	'features' => [
		...
		'database' => [
			...
			'collect_models_actions' => env('CLOCKWORK_DATABASE_COLLECT_MODELS_ACTIONS', false), // HUGE
			// Collect details of retrieved models (very high performance impact with a lot of models retrieved)
			// THIS BREAKS CLOCKWORK IF THE MODELS HAVE LOTS OF DATA SO SET LOG_LEVEL=debug if you need it
		...
		'events' => [
			...
			'ignored_events' => [
				...
				// 'user.registered'
				// Might want to ignore 'retrieved' if you have lots of records
				//KeyWritten::class, // Really slow with genealabs/laravel-model-caching
				//CacheHit::class, // Really slow with genealabs/laravel-model-caching
	...
	|------------------------------------------------------------------------------------------------------------------
	|
	| Clockwork comes with a web UI accessible via https://local.quantimo.do/__clockwork/app#. Here you can enable or disable this
	...
	*/
	...
	|
	*/
	'toolbar' => env('CLOCKWORK_TOOLBAR', Env::isLocal()),
	/*
	|------------------------------------------------------------------------------------------------------------------
	...
	*/
	'queue' => [
		...
		'except' => [// App\Jobs\ExpensiveJob::class
		],
		// List of queue jobs that should be collected, any other queue job will not be collected if not empty
		'only' => [// App\Jobs\BuggyJob::class
		],
	],
	/*
	|------------------------------------------------------------------------------------------------------------------
	...
	*/
	'tests' => [
		...
		'except' => [// Tests\Unit\ExampleTest::class
		],
	],
	/*
	|------------------------------------------------------------------------------------------------------------------
	...
	*/
	...
	|
	*/
	'authentication' => env('CLOCKWORK_AUTHENTICATION', !EnvOverride::isLocal()),
	...
	*/
	...
	'serialization_depth' => env('CLOCKWORK_SERIALIZATION_DEPTH', 5),
	...
	'serialization_blackbox' => [
		...
		QMUserVariable::class,
		QMConnector::class,
		AdditionalMetaData::class,
		MoodscopeConnector::class,
		ConnectorRequest::class,
		LusitanianGuzzleClient::class,
