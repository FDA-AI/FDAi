...
class AddForeignKeysToCorrelationUsefulnessVotesTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('correlation_usefulness_votes', function (Blueprint $table) {
            $table->foreign(['global_variable_relationship_id'], 'correlation_usefulness_votes_global_variable_relationships_id_fk')->references(['id'])->on('global_variable_relationships')->onUpdate('NO ACTION')->onDelete('NO ACTION');
            ...
            $table->foreign(['correlation_id'], 'correlation_usefulness_votes_correlations_id_fk')->references(['id'])->on('user_variable_relationships')->onUpdate('NO ACTION')->onDelete('NO ACTION');
    ...
    {
        Schema::table('correlation_usefulness_votes', function (Blueprint $table) {
            $table->dropForeign('correlation_usefulness_votes_global_variable_relationships_id_fk');
