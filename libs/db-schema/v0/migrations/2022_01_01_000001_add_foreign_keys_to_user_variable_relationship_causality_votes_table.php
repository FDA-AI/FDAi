...
class AddForeignKeysToCorrelationCausalityVotesTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('correlation_causality_votes', function (Blueprint $table) {
            ...
            $table->foreign(['correlation_id'], 'correlation_causality_votes_correlations_id_fk')->references(['id'])->on('user_variable_relationships')->onUpdate('NO ACTION')->onDelete('NO ACTION');
