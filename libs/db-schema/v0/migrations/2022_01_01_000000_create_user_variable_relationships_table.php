...
class CreateCorrelationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('user_variable_relationships', function (Blueprint $table) {
            ...
            $table->double('predictive_pearson_correlation_coefficient')->nullable()->comment('Predictive Pearson User Variable Relationship Coefficient');
            $table->double('reverse_pearson_correlation_coefficient')->nullable()->comment('User Variable Relationship when cause and effect are reversed. For any causal relationship, the forward correlation should exceed the reverse correlation');
            ...
            $table->text('correlations_over_durations')->comment('Pearson user_variable_relationships calculated with various duration of action lengths. This can be used to compare short and long term effects. ');
            $table->text('correlations_over_delays')->comment('Pearson user_variable_relationships calculated with various onset delay lags used to identify reversed causality or asses the significant of a correlation with a given lag parameters. ');
