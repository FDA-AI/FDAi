...
class CreateStudiesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('studies', function (Blueprint $table) {
            ...
            $table->unsignedInteger('cause_variable_id')->index('studies_cause_variable_id')->comment('variable ID of the cause variable for which the user desires user_variable_relationships');
            $table->unsignedInteger('effect_variable_id')->index('studies_effect_variable_id')->comment('variable ID of the effect variable for which the user desires user_variable_relationships');
