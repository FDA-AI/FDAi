...
class CreateGlobalVariableRelationshipsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('global_variable_relationships', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('wp_post_id')->nullable()->index('global_variable_relationships_wp_posts_ID_fk');
            $table->unsignedTinyInteger('cause_variable_category_id')->index('global_variable_relationships_cause_variable_category_id_fk');
            $table->unsignedTinyInteger('effect_variable_category_id')->index('global_variable_relationships_effect_variable_category_id_fk');
            ...
            $table->json('charts');
            $table->unsignedInteger('number_of_variables_where_best_global_variable_relationship')->comment('Number of Variables for this Best Global Variable Relationship.');
