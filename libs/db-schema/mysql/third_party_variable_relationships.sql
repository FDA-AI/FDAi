create table if not exists third_party_variable_relationships
(
...
create index cause
    on third_party_variable_relationships (cause_id);

create index effect
    on third_party_variable_relationships (effect_id);
