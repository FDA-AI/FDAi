create table if not exists user_variable_relationships
(
...
create index correlations_user_id_deleted_at_qm_score_index
    on user_variable_relationships (user_id, deleted_at, qm_score);

create index user_id_cause_variable_id_deleted_at_qm_score_index
    on user_variable_relationships (user_id, cause_variable_id, deleted_at, qm_score);

create index user_id_effect_variable_id_deleted_at_qm_score_index
    on user_variable_relationships (user_id, effect_variable_id, deleted_at, qm_score);
