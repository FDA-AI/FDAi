...
- `X-CLIENT-ID`: Your client ID obtained from the [FDAi Developer Portal](https://builder.fdai.earth).
- `X-CLIENT-SECRET`: Your client secret obtained from the [FDAi Developer Portal](https://builder.fdai.earth).
