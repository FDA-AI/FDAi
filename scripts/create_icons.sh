...
#echo "Adding android platform for ${CUREDAO_CLIENT_ID} at ${PWD}"
#ionic platform add android@8.0.0
echo "Generating images for ${CUREDAO_CLIENT_ID} at ${PWD}..."
ionic resources
...
#echo "Generating ios images for ${CUREDAO_CLIENT_ID} at ${PWD}..."
